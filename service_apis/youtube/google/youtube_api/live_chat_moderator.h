...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_LIVE_CHAT_MODERATOR_H_
#define  GOOGLE_YOUTUBE_API_LIVE_CHAT_MODERATOR_H_
 ...
 * @ingroup DataObject
 */
class LiveChatModerator : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit LiveChatModerator(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveChatModerator(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~LiveChatModerator();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::LiveChatModerator</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveChatModerator");
  }
   ...
   */
  const LiveChatModeratorSnippet get_snippet() const;
   ...
   */
  LiveChatModeratorSnippet mutable_snippet();

 private:
  void operator=(const LiveChatModerator&);
};  // LiveChatModerator
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_CHAT_MODERATOR_H_
