...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_LIVE_CHAT_MODERATOR_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_LIVE_CHAT_MODERATOR_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class LiveChatModeratorListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static LiveChatModeratorListResponse* New();
   ...
   */
  explicit LiveChatModeratorListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveChatModeratorListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~LiveChatModeratorListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::LiveChatModeratorListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveChatModeratorListResponse");
  }
   ...
   */
  const client::JsonCppArray<LiveChatModerator > get_items() const;
   ...
   */
  client::JsonCppArray<LiveChatModerator > mutable_items();
 ...
 private:
  void operator=(const LiveChatModeratorListResponse&);
};  // LiveChatModeratorListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_CHAT_MODERATOR_LIST_RESPONSE_H_
