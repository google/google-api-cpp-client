...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_ACTIVITY_CONTENT_DETAILS_SUBSCRIPTION_H_
#define  GOOGLE_YOUTUBE_API_ACTIVITY_CONTENT_DETAILS_SUBSCRIPTION_H_
 ...
 * @ingroup DataObject
 */
class ActivityContentDetailsSubscription : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ActivityContentDetailsSubscription(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ActivityContentDetailsSubscription(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::ActivityContentDetailsSubscription</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::ActivityContentDetailsSubscription");
  }
 ...
 private:
  void operator=(const ActivityContentDetailsSubscription&);
};  // ActivityContentDetailsSubscription
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_ACTIVITY_CONTENT_DETAILS_SUBSCRIPTION_H_
