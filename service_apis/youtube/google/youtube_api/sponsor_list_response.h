...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_SPONSOR_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_SPONSOR_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class SponsorListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static SponsorListResponse* New();
   ...
   */
  explicit SponsorListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SponsorListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SponsorListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::SponsorListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::SponsorListResponse");
  }
   ...
   */
  const client::JsonCppArray<Sponsor > get_items() const;
   ...
   */
  client::JsonCppArray<Sponsor > mutable_items();
 ...
 private:
  void operator=(const SponsorListResponse&);
};  // SponsorListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_SPONSOR_LIST_RESPONSE_H_
