...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_COMMENT_THREAD_H_
#define  GOOGLE_YOUTUBE_API_COMMENT_THREAD_H_
 ...
 * @ingroup DataObject
 */
class CommentThread : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit CommentThread(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CommentThread(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::CommentThread</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::CommentThread");
  }
 ...
 private:
  void operator=(const CommentThread&);
};  // CommentThread
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_COMMENT_THREAD_H_
