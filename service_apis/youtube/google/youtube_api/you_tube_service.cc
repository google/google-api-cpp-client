...
const char YouTubeService::googleapis_API_NAME[] = {"youtube"};

const char YouTubeService::googleapis_API_VERSION[] = {"v3"};

const char YouTubeService::googleapis_API_GENERATOR[] = {
  "google-apis-code-generator 1.5.1 / 0.1.4"};


const char YouTubeService::SCOPES::YOUTUBE[] = {"https://www.googleapis.com/auth/youtube"};

const char YouTubeService::SCOPES::YOUTUBE_FORCE_SSL[] = {"https://www.googleapis.com/auth/youtube.force-ssl"};

const char YouTubeService::SCOPES::YOUTUBE_READONLY[] = {"https://www.googleapis.com/auth/youtube.readonly"};

const char YouTubeService::SCOPES::YOUTUBE_UPLOAD[] = {"https://www.googleapis.com/auth/youtube.upload"};

const char YouTubeService::SCOPES::YOUTUBEPARTNER[] = {"https://www.googleapis.com/auth/youtubepartner"};

const char YouTubeService::SCOPES::YOUTUBEPARTNER_CHANNEL_AUDIT[] = {"https://www.googleapis.com/auth/youtubepartner-channel-audit"};
...
util::Status SubscriptionsResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  ...
  if (_have_my_recent_subscribers_) {
    StrAppend(target, sep, "myRecentSubscribers=",
              client::CppValueToEscapedUrlValue(
                my_recent_subscribers_));
    sep = "&";
  }
  if (_have_my_subscribers_) {
    StrAppend(target, sep, "mySubscribers=",
...
// Standard constructor.
SuperChatEventsResource_ListMethod::SuperChatEventsResource_ListMethod(
    const YouTubeService* _service_, client::AuthorizationCredential* _credential_, const StringPiece& part)
    : YouTubeServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
util::Status SuperChatEventsResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
    StrAppend(target, sep, "part=",
              client::CppValueToEscapedUrlValue(
                part_));
...
util::Status SuperChatEventsResource_ListMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  return YouTubeServiceBaseRequest::AppendVariable(
...
util::Status VideosResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  ...
  if (_have_max_height_) {
    StrAppend(target, sep, "maxHeight=",
              client::CppValueToEscapedUrlValue(
                max_height_));
    sep = "&";
  }
...
YouTubeService::SuperChatEventsResource::SuperChatEventsResource(YouTubeService* service)
  : service_(service) {
}



SuperChatEventsResource_ListMethod* YouTubeService::SuperChatEventsResource::NewListMethod(client::AuthorizationCredential* _credential_, const StringPiece& part) const {
  return new SuperChatEventsResource_ListMethod(service_, _credential_, part);
}


SuperChatEventsResource_ListMethodPager* YouTubeService::SuperChatEventsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const StringPiece& part) const {
  return new client::EncapsulatedServiceRequestPager<SuperChatEventsResource_ListMethod, SuperChatEventListResponse>(new SuperChatEventsResource_ListMethod(service_, _credential_, part));
}
