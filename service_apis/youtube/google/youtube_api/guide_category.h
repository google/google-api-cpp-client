...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_GUIDE_CATEGORY_H_
#define  GOOGLE_YOUTUBE_API_GUIDE_CATEGORY_H_
 ...
 * @ingroup DataObject
 */
class GuideCategory : public client::JsonCppData {
 public:
   ...
   */
  explicit GuideCategory(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit GuideCategory(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~GuideCategory();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::GuideCategory</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::GuideCategory");
  }
   ...
   */
  const GuideCategorySnippet get_snippet() const {
