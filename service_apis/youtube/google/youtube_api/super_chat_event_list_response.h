...
//     C++: 0.1.4
#ifndef  GOOGLE_YOUTUBE_API_SUPER_CHAT_EVENT_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_SUPER_CHAT_EVENT_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class SuperChatEventListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static SuperChatEventListResponse* New();
   ...
   */
  explicit SuperChatEventListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SuperChatEventListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SuperChatEventListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::SuperChatEventListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::SuperChatEventListResponse");
  }
   ...
   */
  const client::JsonCppArray<SuperChatEvent > get_items() const;
   ...
   */
  client::JsonCppArray<SuperChatEvent > mutable_items();
 ...
 private:
  void operator=(const SuperChatEventListResponse&);
};  // SuperChatEventListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_SUPER_CHAT_EVENT_LIST_RESPONSE_H_
