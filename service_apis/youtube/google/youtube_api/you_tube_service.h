...
class ChannelSectionsResource_InsertMethod : public YouTubeServiceBaseRequest {
 ...
 private:
  ...
  bool _have_on_behalf_of_content_owner_ : 1;
  bool _have_on_behalf_of_content_owner_channel_ : 1;  string _content_;
...
class SubscriptionsResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
  ...
  virtual ~SubscriptionsResource_ListMethod();
    ...
    /**
     * Clears the '<code>myRecentSubscribers</code>' attribute so it is no
     * longer set.
     */
    void clear_my_recent_subscribers() {
      _have_my_recent_subscribers_ = false;
      client::ClearCppValueHelper(&my_recent_subscribers_);
    }


    /**
     * Gets the optional '<code>myRecentSubscribers</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    bool get_my_recent_subscribers() const { return my_recent_subscribers_; }

    /**
     * Sets the '<code>myRecentSubscribers</code>' attribute.
     *
     * @param[in] value Set this parameter's value to true to retrieve a feed of
     * the subscribers of the authenticated user in reverse chronological order
     * (newest first).
     */
    void set_my_recent_subscribers(bool value) {
      _have_my_recent_subscribers_ = true;
      my_recent_subscribers_ = value;
    }
 ...
 private:
  ...
  bool _have_max_results_ : 1;
  bool _have_mine_ : 1;
  bool _have_my_recent_subscribers_ : 1;
  bool _have_my_subscribers_ : 1;
  bool _have_on_behalf_of_content_owner_ : 1;
  bool _have_on_behalf_of_content_owner_channel_ : 1;
  bool _have_order_ : 1;
 ...
 * https://www.googleapis.com/auth/youtube.readonly
 */
class SuperChatEventsResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   *            In practice this is supplied by the user code that is
   *            creating the method instance.
   * @param[in] part The part parameter specifies the superChatEvent resource
   * parts that the API response will include. Supported values are id and
   * snippet.
   */
  SuperChatEventsResource_ListMethod(
      const YouTubeService* _service_,
      client::AuthorizationCredential* _credential_,
      const StringPiece& part);
   ...
   * Standard destructor.
   */
  virtual ~SuperChatEventsResource_ListMethod();
   ...
   */
  util::Status ExecuteAndParseResponse(
      SuperChatEventListResponse* data) {
    return YouTubeServiceBaseRequest::ExecuteAndParseResponse(data);
  }
 ...
 private:
  ...
  bool _have_max_results_ : 1;
  bool _have_page_token_ : 1;
  DISALLOW_COPY_AND_ASSIGN(SuperChatEventsResource_ListMethod);
};

typedef client::ServiceRequestPager<
            SuperChatEventsResource_ListMethod,
            SuperChatEventListResponse>
        SuperChatEventsResource_ListMethodPager;
...
class VideosResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
  ...
  virtual ~VideosResource_ListMethod();
    ...
    /**
     * Clears the '<code>maxHeight</code>' attribute so it is no longer set.
     */
    void clear_max_height() {
      _have_max_height_ = false;
      client::ClearCppValueHelper(&max_height_);
    }


    /**
     * Gets the optional '<code>maxHeight</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    uint32 get_max_height() const { return max_height_; }

    /**
     * Sets the '<code>maxHeight</code>' attribute.
     *
     * @param[in] value The maxHeight parameter specifies a maximum height of
     * the embedded player. If maxWidth is provided, maxHeight may not be
     * reached in order to not violate the width request.
     */
    void set_max_height(uint32 value) {
      _have_max_height_ = true;
      max_height_ = value;
    }
    ...
    /**
     * Clears the '<code>maxWidth</code>' attribute so it is no longer set.
     */
    void clear_max_width() {
      _have_max_width_ = false;
      client::ClearCppValueHelper(&max_width_);
    }


    /**
     * Gets the optional '<code>maxWidth</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    uint32 get_max_width() const { return max_width_; }

    /**
     * Sets the '<code>maxWidth</code>' attribute.
     *
     * @param[in] value The maxWidth parameter specifies a maximum width of the
 ...
 private:
  ...
  bool _have_max_height_ : 1;
  bool _have_max_results_ : 1;
  bool _have_max_width_ : 1;
...
class YouTubeService : public client::ClientService {
 public:
  ...
  class SuperChatEventsResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit SuperChatEventsResource(YouTubeService* service);
     ...
     *           then destroy it when they are finished.
     */
    SuperChatEventsResource_ListMethod* NewListMethod(
        client::AuthorizationCredential* _credential_,
        const StringPiece& part) const;
     ...
     * @see googleapis::googleapis::ServiceRequestPager
     */
    SuperChatEventsResource_ListMethodPager* NewListMethodPager(
        client::AuthorizationCredential* _credential_,
        const StringPiece& part) const;
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(SuperChatEventsResource);
  };
   ...
   * Gets the  resource method factory.
   *
   * @return SuperChatEventsResource for creating methods.
   */
  const SuperChatEventsResource& get_super_chat_events() const {
    return super_chat_events_;
  }
  ...
  class SCOPES {
   public:
     ...
     * Manage your YouTube account.
     */
    static const char YOUTUBE_FORCE_SSL[];

    /**
     * View your YouTube account.
     */
    static const char YOUTUBE_READONLY[];

    /**
     * Manage your YouTube videos.
     */
    static const char YOUTUBE_UPLOAD[];

    /**
     * View and manage your assets and associated content on YouTube.
     */
    static const char YOUTUBEPARTNER[];

    /**
     * View private information of your YouTube channel relevant during the
     * audit process with a YouTube partner.
     */
    static const char YOUTUBEPARTNER_CHANNEL_AUDIT[];
 ...
 private:
  ...
  SuperChatEventsResource super_chat_events_;
