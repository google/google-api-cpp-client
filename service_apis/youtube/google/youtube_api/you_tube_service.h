...
class CommentThreadsResource_InsertMethod : public YouTubeServiceBaseRequest {
 public:
  ...
  virtual ~CommentThreadsResource_InsertMethod();
     ...
     *
     * @param[in] value The shareOnGooglePlus determines whether this thread
...
class CommentThreadsResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
  ...
  virtual ~CommentThreadsResource_ListMethod();
     ...
     * API to return the comment threads of all videos of the channel and the
     ...
     * Sets the '<code>channelId</code>' attribute.
     *
     * @param[in] value The channelId parameter instructs the API to return the
     ...
     *
     * @param[in] value The videoId parameter instructs the API to return the
...
class CommentsResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
   ...
   *            In practice this is supplied by the user code that is
   *            creating the method instance.
   * @param[in] part The part parameter specifies the comment resource parts
  ...
  virtual ~CommentsResource_ListMethod();
     ...
     *
     * @param[in] value Set this parameter's value to html or plainText to
     * instruct the API to return the comments left by users formatted as HTML
     * or as plain text.
     */
    void set_text_format(const string& value) {
      _have_text_format_ = true;
...
class CommentsResource_SetModerationStatusMethod : public YouTubeServiceBaseRequest {
 public:
   ...
   * @param[in] moderation_status Determines the new moderation status of the
   * specified comments.
   */
  ...
  virtual ~CommentsResource_SetModerationStatusMethod();
     ...
     *
     * @param[in] value The banAuthor paramter, if set to true, adds the author
     * of the comment to the ban list. This means all future comments of the
...
class VideosResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
  ...
  virtual ~VideosResource_ListMethod();
     ...
     * Sets the '<code>hl</code>' attribute.
     *
     * @param[in] value The hl parameter instructs the API to return a localized
     * version of the video details. If localized text is nor available for the
     * requested language, the localizations object in the API response will
     * contain the requested information in the default language instead. The
     * parameter value is a BCP-47 language code. Your application can determine
     * whether the requested localization was returned by checking the value of
     * the snippet.localized.language property in the API response.
     */
    void set_hl(const string& value) {
      _have_hl_ = true;
      hl_ = value;
 ...
 public:
  ...
  class VideosResource {
   public:
     ...
     * The part names that you can include in the parameter value are id,
     * snippet, contentDetails, fileDetails, liveStreamingDetails,
     * localizations, player, processingDetails, recordingDetails, statistics,
