 ...
 *      <tr><th>Generated At<td>2015-03-12 20:35:33 UTC
...
class SearchResource_ListMethod : public YouTubeServiceBaseRequest {
 public:
  ...
  virtual ~SearchResource_ListMethod();
    ...
    /**
     * @deprecated
     * @see clear_relevance_language
     */
    void clear_relevanceLanguage() {
      clear_relevance_language();
    }
   ...
   static const StringPiece googleapis_API_GENERATOR;
    ...
    class VideosResource {
     public:
       ...
       *
       * The part names that you can include in the parameter value are snippet,
       * contentDetails, fileDetails, liveStreamingDetails, localizations,
       * player, processingDetails, recordingDetails, statistics, status,
       * suggestions, and topicDetails. However, not all of those parts contain
       * properties that can be set when setting or updating a video's metadata.
