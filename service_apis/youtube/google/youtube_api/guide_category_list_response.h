...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_GUIDE_CATEGORY_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class GuideCategoryListResponse : public client::JsonCppData {
 public:
   ...
   */
  static GuideCategoryListResponse* New();
   ...
   */
  explicit GuideCategoryListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit GuideCategoryListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~GuideCategoryListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::GuideCategoryListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::GuideCategoryListResponse");
  }
   ...
   */
  const client::JsonCppArray<GuideCategory > get_items() const {
   ...
   */
  client::JsonCppArray<GuideCategory > mutable_items() {
 ...
 private:
  void operator=(const GuideCategoryListResponse&);
};  // GuideCategoryListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_GUIDE_CATEGORY_LIST_RESPONSE_H_
