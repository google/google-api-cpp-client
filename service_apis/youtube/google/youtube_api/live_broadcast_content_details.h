...
class LiveBroadcastContentDetails : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>boundStreamLastUpdateTimeMs</code>' attribute was
   * set.
   *
   * @return true if the '<code>boundStreamLastUpdateTimeMs</code>' attribute
   * was set.
   */
  bool has_bound_stream_last_update_time_ms() const {
    return Storage().isMember("boundStreamLastUpdateTimeMs");
  }

  /**
   * Clears the '<code>boundStreamLastUpdateTimeMs</code>' attribute.
   */
  void clear_bound_stream_last_update_time_ms() {
    MutableStorage()->removeMember("boundStreamLastUpdateTimeMs");
  }


  /**
   * Get the value of the '<code>boundStreamLastUpdateTimeMs</code>' attribute.
   */
  client::DateTime get_bound_stream_last_update_time_ms() const {
    const Json::Value& storage = Storage("boundStreamLastUpdateTimeMs");
    return client::JsonValueToCppValueHelper<client::DateTime >(storage);
  }

  /**
   * Change the '<code>boundStreamLastUpdateTimeMs</code>' attribute.
   *
  ...
  void set_bound_stream_last_update_time_ms(client::DateTime value) {
    client::SetJsonValueFromCppValueHelper<client::DateTime >(
      value, MutableStorage("boundStreamLastUpdateTimeMs"));
  }
  ...
  /**
   * Determine if the '<code>projection</code>' attribute was set.
   *
   * @return true if the '<code>projection</code>' attribute was set.
   */
  bool has_projection() const {
    return Storage().isMember("projection");
  }

  /**
   * Clears the '<code>projection</code>' attribute.
   */
  void clear_projection() {
    MutableStorage()->removeMember("projection");
  }


  /**
   * Get the value of the '<code>projection</code>' attribute.
   */
  const StringPiece get_projection() const {
    const Json::Value& v = Storage("projection");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>projection</code>' attribute.
   *
  ...
  void set_projection(const StringPiece& value) {
    *MutableStorage("projection") = value.data();
  }
