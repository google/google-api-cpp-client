...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_LIVE_CHAT_MESSAGE_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_LIVE_CHAT_MESSAGE_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class LiveChatMessageListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static LiveChatMessageListResponse* New();
   ...
   */
  explicit LiveChatMessageListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveChatMessageListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~LiveChatMessageListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::LiveChatMessageListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveChatMessageListResponse");
  }
   ...
   */
  const client::JsonCppArray<LiveChatMessage > get_items() const;
   ...
   */
  client::JsonCppArray<LiveChatMessage > mutable_items();
  ...
  /**
   * Determine if the '<code>offlineAt</code>' attribute was set.
   *
   * @return true if the '<code>offlineAt</code>' attribute was set.
   */
  bool has_offline_at() const {
    return Storage().isMember("offlineAt");
  }

  /**
   * Clears the '<code>offlineAt</code>' attribute.
   */
  void clear_offline_at() {
    MutableStorage()->removeMember("offlineAt");
  }


  /**
   * Get the value of the '<code>offlineAt</code>' attribute.
   */
  client::DateTime get_offline_at() const {
    const Json::Value& storage = Storage("offlineAt");
    return client::JsonValueToCppValueHelper<client::DateTime >(storage);
  }

  /**
   * Change the '<code>offlineAt</code>' attribute.
   *
   ...
   * @param[in] value The new value.
   */
  void set_offline_at(client::DateTime value) {
    client::SetJsonValueFromCppValueHelper<client::DateTime >(
      value, MutableStorage("offlineAt"));
  }
  ...
  /**
   * Determine if the '<code>pollingIntervalMillis</code>' attribute was set.
   *
   * @return true if the '<code>pollingIntervalMillis</code>' attribute was set.
   */
  bool has_polling_interval_millis() const {
    return Storage().isMember("pollingIntervalMillis");
  }

  /**
   * Clears the '<code>pollingIntervalMillis</code>' attribute.
   */
  void clear_polling_interval_millis() {
    MutableStorage()->removeMember("pollingIntervalMillis");
  }


  /**
   * Get the value of the '<code>pollingIntervalMillis</code>' attribute.
   */
  uint32 get_polling_interval_millis() const {
    const Json::Value& storage = Storage("pollingIntervalMillis");
    return client::JsonValueToCppValueHelper<uint32 >(storage);
  }

  /**
   * Change the '<code>pollingIntervalMillis</code>' attribute.
   *
   * The amount of time the client should wait before polling again.
   *
   * @param[in] value The new value.
   */
  void set_polling_interval_millis(uint32 value) {
    client::SetJsonValueFromCppValueHelper<uint32 >(
      value, MutableStorage("pollingIntervalMillis"));
  }
 ...
 private:
  void operator=(const LiveChatMessageListResponse&);
};  // LiveChatMessageListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_CHAT_MESSAGE_LIST_RESPONSE_H_
