...
//     C++: 0.1.4
#ifndef  GOOGLE_YOUTUBE_API_SEARCH_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_SEARCH_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class SearchListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SearchListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SearchListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SearchListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::SearchListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::SearchListResponse");
  }
   ...
   */
  const client::JsonCppArray<SearchResult > get_items() const;
   ...
   */
  client::JsonCppArray<SearchResult > mutable_items();
  ...
  /**
   * Determine if the '<code>regionCode</code>' attribute was set.
   *
   * @return true if the '<code>regionCode</code>' attribute was set.
   */
  bool has_region_code() const {
    return Storage().isMember("regionCode");
  }

  /**
   * Clears the '<code>regionCode</code>' attribute.
   */
  void clear_region_code() {
    MutableStorage()->removeMember("regionCode");
  }


  /**
   * Get the value of the '<code>regionCode</code>' attribute.
   */
  const StringPiece get_region_code() const {
    const Json::Value& v = Storage("regionCode");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>regionCode</code>' attribute.
   * @param[in] value The new value.
   */
  void set_region_code(const StringPiece& value) {
    *MutableStorage("regionCode") = value.data();
  }
 ...
 private:
  void operator=(const SearchListResponse&);
};  // SearchListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_SEARCH_LIST_RESPONSE_H_
