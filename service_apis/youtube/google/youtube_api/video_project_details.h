...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_VIDEO_PROJECT_DETAILS_H_
#define  GOOGLE_YOUTUBE_API_VIDEO_PROJECT_DETAILS_H_
 ...
 * @ingroup DataObject
 */
class VideoProjectDetails : public client::JsonCppData {
 public:
  /**
   ...
   */
  static VideoProjectDetails* New();
   ...
   */
  explicit VideoProjectDetails(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VideoProjectDetails(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::VideoProjectDetails</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::VideoProjectDetails");
  }
 ...
 private:
  void operator=(const VideoProjectDetails&);
};  // VideoProjectDetails
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_VIDEO_PROJECT_DETAILS_H_
