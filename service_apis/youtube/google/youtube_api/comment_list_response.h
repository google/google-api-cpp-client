...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_COMMENT_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_COMMENT_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class CommentListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static CommentListResponse* New();
   ...
   */
  explicit CommentListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CommentListResponse(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::CommentListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::CommentListResponse");
  }
 ...
 private:
  void operator=(const CommentListResponse&);
};  // CommentListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_COMMENT_LIST_RESPONSE_H_
