...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_PLAYLIST_LOCALIZATION_H_
#define  GOOGLE_YOUTUBE_API_PLAYLIST_LOCALIZATION_H_
 ...
 * @ingroup DataObject
 */
class PlaylistLocalization : public client::JsonCppData {
 public:
  /**
   ...
   */
  static PlaylistLocalization* New();
   ...
   */
  explicit PlaylistLocalization(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit PlaylistLocalization(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~PlaylistLocalization();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::PlaylistLocalization</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::PlaylistLocalization");
  }
 ...
 private:
  void operator=(const PlaylistLocalization&);
};  // PlaylistLocalization
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_PLAYLIST_LOCALIZATION_H_
