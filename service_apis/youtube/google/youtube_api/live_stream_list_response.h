...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_LIVE_STREAM_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class LiveStreamListResponse : public client::JsonCppData {
 public:
   ...
   */
  static LiveStreamListResponse* New();
   ...
   */
  explicit LiveStreamListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveStreamListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~LiveStreamListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::LiveStreamListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveStreamListResponse");
  }
   ...
   */
  const client::JsonCppArray<LiveStream > get_items() const {
   ...
   */
  client::JsonCppArray<LiveStream > mutable_items() {
 ...
 private:
  void operator=(const LiveStreamListResponse&);
};  // LiveStreamListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_STREAM_LIST_RESPONSE_H_
