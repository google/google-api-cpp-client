...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_I18N_LANGUAGE_H_
#define  GOOGLE_YOUTUBE_API_I18N_LANGUAGE_H_
 ...
 * @ingroup DataObject
 */
class I18nLanguage : public client::JsonCppData {
 public:
   ...
   */
  explicit I18nLanguage(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit I18nLanguage(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~I18nLanguage();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::I18nLanguage</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::I18nLanguage");
  }
   ...
   */
  const I18nLanguageSnippet get_snippet() const {
     const Json::Value& storage = Storage("snippet");
    return client::JsonValueToCppValueHelper<I18nLanguageSnippet >(storage);
  }
   ...
   */
  I18nLanguageSnippet mutable_snippet() {
    Json::Value* storage = MutableStorage("snippet");
    return client::JsonValueToMutableCppValueHelper<I18nLanguageSnippet >(storage);
  }

 private:
  void operator=(const I18nLanguage&);
};  // I18nLanguage
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_I18N_LANGUAGE_H_
