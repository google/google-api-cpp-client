...
//     C++: 0.1.4
#ifndef  GOOGLE_YOUTUBE_API_SUPER_CHAT_EVENT_H_
#define  GOOGLE_YOUTUBE_API_SUPER_CHAT_EVENT_H_
 ...
 * @ingroup DataObject
 */
class SuperChatEvent : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SuperChatEvent(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SuperChatEvent(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SuperChatEvent();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::SuperChatEvent</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::SuperChatEvent");
  }
   ...
   */
  const SuperChatEventSnippet get_snippet() const;
   ...
   */
  SuperChatEventSnippet mutable_snippet();

 private:
  void operator=(const SuperChatEvent&);
};  // SuperChatEvent
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_SUPER_CHAT_EVENT_H_
