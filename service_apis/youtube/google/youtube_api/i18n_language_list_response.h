...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_I18N_LANGUAGE_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class I18nLanguageListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static I18nLanguageListResponse* New();
   ...
   */
  explicit I18nLanguageListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit I18nLanguageListResponse(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::I18nLanguageListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::I18nLanguageListResponse");
  }
   ...
   */
  const client::JsonCppArray<I18nLanguage > get_items() const;
   ...
   */
  client::JsonCppArray<I18nLanguage > mutable_items();
 ...
 private:
  void operator=(const I18nLanguageListResponse&);
};  // I18nLanguageListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_I18N_LANGUAGE_LIST_RESPONSE_H_
