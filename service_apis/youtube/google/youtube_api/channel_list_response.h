...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_CHANNEL_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_CHANNEL_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class ChannelListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static ChannelListResponse* New();
   ...
   */
  explicit ChannelListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ChannelListResponse(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::ChannelListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::ChannelListResponse");
  }
   ...
   */
  const client::JsonCppArray<Channel > get_items() const;
   ...
   */
  client::JsonCppArray<Channel > mutable_items();
 ...
 private:
  void operator=(const ChannelListResponse&);
};  // ChannelListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_CHANNEL_LIST_RESPONSE_H_
