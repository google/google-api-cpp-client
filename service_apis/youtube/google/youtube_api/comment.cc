...
const CommentSnippet Comment::get_snippet() const {
   const Json::Value& storage = Storage("snippet");
   return client::JsonValueToCppValueHelper<CommentSnippet >(storage);
}

CommentSnippet Comment::mutable_snippet() {
  Json::Value* storage = MutableStorage("snippet");
  return client::JsonValueToMutableCppValueHelper<CommentSnippet >(storage);
}
}  // namespace google_youtube_api
