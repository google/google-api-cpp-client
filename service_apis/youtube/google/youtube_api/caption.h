...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_CAPTION_H_
#define  GOOGLE_YOUTUBE_API_CAPTION_H_
 ...
 * @ingroup DataObject
 */
class Caption : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit Caption(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Caption(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::Caption</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::Caption");
  }
   ...
   */
  const CaptionSnippet get_snippet() const;
   ...
   */
  CaptionSnippet mutable_snippet();

 private:
  void operator=(const Caption&);
};  // Caption
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_CAPTION_H_
