...
class VideoContentDetails : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>hasCustomThumbnail</code>' attribute was set.
   *
   * @return true if the '<code>hasCustomThumbnail</code>' attribute was set.
   */
  bool has_has_custom_thumbnail() const {
    return Storage().isMember("hasCustomThumbnail");
  }

  /**
   * Clears the '<code>hasCustomThumbnail</code>' attribute.
   */
  void clear_has_custom_thumbnail() {
    MutableStorage()->removeMember("hasCustomThumbnail");
  }


  /**
   * Get the value of the '<code>hasCustomThumbnail</code>' attribute.
   */
  bool get_has_custom_thumbnail() const {
    const Json::Value& storage = Storage("hasCustomThumbnail");
    return client::JsonValueToCppValueHelper<bool >(storage);
  }

  /**
   * Change the '<code>hasCustomThumbnail</code>' attribute.
   *
