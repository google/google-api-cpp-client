...
SearchResultSnippet* SearchResultSnippet::New() {
  return new client::JsonCppCapsule<SearchResultSnippet>;
}

// Standard immutable constructor.
SearchResultSnippet::SearchResultSnippet(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
SearchResultSnippet::SearchResultSnippet(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const ThumbnailDetails SearchResultSnippet::get_thumbnails() const {
   const Json::Value& storage = Storage("thumbnails");
   return client::JsonValueToCppValueHelper<ThumbnailDetails >(storage);
}

ThumbnailDetails SearchResultSnippet::mutable_thumbnails() {
