...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_PLAYLIST_ITEM_STATUS_H_
#define  GOOGLE_YOUTUBE_API_PLAYLIST_ITEM_STATUS_H_
 ...
 * @ingroup DataObject
 */
class PlaylistItemStatus : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit PlaylistItemStatus(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit PlaylistItemStatus(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::PlaylistItemStatus</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::PlaylistItemStatus");
  }
 ...
 private:
  void operator=(const PlaylistItemStatus&);
};  // PlaylistItemStatus
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_PLAYLIST_ITEM_STATUS_H_
