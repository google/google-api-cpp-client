...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_LIVE_CHAT_BAN_H_
#define  GOOGLE_YOUTUBE_API_LIVE_CHAT_BAN_H_
 ...
 * @ingroup DataObject
 */
class LiveChatBan : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit LiveChatBan(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveChatBan(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::LiveChatBan</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveChatBan");
  }
   ...
   */
  const LiveChatBanSnippet get_snippet() const;
   ...
   */
  LiveChatBanSnippet mutable_snippet();

 private:
  void operator=(const LiveChatBan&);
};  // LiveChatBan
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_CHAT_BAN_H_
