...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_I18N_REGION_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_I18N_REGION_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class I18nRegionListResponse : public client::JsonCppData {
 public:
   ...
   */
  static I18nRegionListResponse* New();
   ...
   */
  explicit I18nRegionListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit I18nRegionListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~I18nRegionListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::I18nRegionListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::I18nRegionListResponse");
  }
   ...
   */
  const client::JsonCppArray<I18nRegion > get_items() const {
   ...
   */
  client::JsonCppArray<I18nRegion > mutable_items() {
 ...
 private:
  void operator=(const I18nRegionListResponse&);
};  // I18nRegionListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_I18N_REGION_LIST_RESPONSE_H_
