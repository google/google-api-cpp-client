...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_LIVE_BROADCAST_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_LIVE_BROADCAST_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class LiveBroadcastListResponse : public client::JsonCppData {
 public:
   ...
   */
  static LiveBroadcastListResponse* New();
   ...
   */
  explicit LiveBroadcastListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveBroadcastListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~LiveBroadcastListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::LiveBroadcastListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveBroadcastListResponse");
  }
   ...
   */
  const client::JsonCppArray<LiveBroadcast > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<LiveBroadcast > >(storage);
  }
   ...
   */
  client::JsonCppArray<LiveBroadcast > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<LiveBroadcast > >(storage);
  }
 ...
 private:
  void operator=(const LiveBroadcastListResponse&);
};  // LiveBroadcastListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_BROADCAST_LIST_RESPONSE_H_
