...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_CHANNEL_SECTION_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_CHANNEL_SECTION_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class ChannelSectionListResponse : public client::JsonCppData {
 public:
   ...
   */
  static ChannelSectionListResponse* New();
   ...
   */
  explicit ChannelSectionListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ChannelSectionListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~ChannelSectionListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::ChannelSectionListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::ChannelSectionListResponse");
  }
   ...
   */
  const client::JsonCppArray<ChannelSection > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<ChannelSection > >(storage);
  }
   ...
   */
  client::JsonCppArray<ChannelSection > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<ChannelSection > >(storage);
  }
 ...
 private:
  void operator=(const ChannelSectionListResponse&);
};  // ChannelSectionListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_CHANNEL_SECTION_LIST_RESPONSE_H_
