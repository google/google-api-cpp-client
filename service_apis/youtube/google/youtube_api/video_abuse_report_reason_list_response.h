...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_VIDEO_ABUSE_REPORT_REASON_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_VIDEO_ABUSE_REPORT_REASON_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class VideoAbuseReportReasonListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static VideoAbuseReportReasonListResponse* New();
   ...
   */
  explicit VideoAbuseReportReasonListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VideoAbuseReportReasonListResponse(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::VideoAbuseReportReasonListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::VideoAbuseReportReasonListResponse");
  }
   ...
   */
  const client::JsonCppArray<VideoAbuseReportReason > get_items() const;
   ...
   */
  client::JsonCppArray<VideoAbuseReportReason > mutable_items();
 ...
 private:
  void operator=(const VideoAbuseReportReasonListResponse&);
};  // VideoAbuseReportReasonListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_VIDEO_ABUSE_REPORT_REASON_LIST_RESPONSE_H_
