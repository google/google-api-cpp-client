...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_THUMBNAIL_SET_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_THUMBNAIL_SET_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class ThumbnailSetResponse : public client::JsonCppData {
 public:
   ...
   */
  static ThumbnailSetResponse* New();
   ...
   */
  explicit ThumbnailSetResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ThumbnailSetResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~ThumbnailSetResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::ThumbnailSetResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::ThumbnailSetResponse");
  }
   ...
   */
  const client::JsonCppArray<ThumbnailDetails > get_items() const {
   ...
   */
  client::JsonCppArray<ThumbnailDetails > mutable_items() {
 ...
 private:
  void operator=(const ThumbnailSetResponse&);
};  // ThumbnailSetResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_THUMBNAIL_SET_RESPONSE_H_
