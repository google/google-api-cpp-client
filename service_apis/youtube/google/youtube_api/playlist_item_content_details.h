...
class PlaylistItemContentDetails : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>videoPublishedAt</code>' attribute was set.
   *
   * @return true if the '<code>videoPublishedAt</code>' attribute was set.
   */
  bool has_video_published_at() const {
    return Storage().isMember("videoPublishedAt");
  }

  /**
   * Clears the '<code>videoPublishedAt</code>' attribute.
   */
  void clear_video_published_at() {
    MutableStorage()->removeMember("videoPublishedAt");
  }


  /**
   * Get the value of the '<code>videoPublishedAt</code>' attribute.
   */
  client::DateTime get_video_published_at() const {
    const Json::Value& storage = Storage("videoPublishedAt");
    return client::JsonValueToCppValueHelper<client::DateTime >(storage);
  }

  /**
   * Change the '<code>videoPublishedAt</code>' attribute.
   *
  ...
  void set_video_published_at(client::DateTime value) {
    client::SetJsonValueFromCppValueHelper<client::DateTime >(
      value, MutableStorage("videoPublishedAt"));
  }
