...
ChannelConversionPings* ChannelConversionPings::New() {
  return new client::JsonCppCapsule<ChannelConversionPings>;
}

// Standard immutable constructor.
ChannelConversionPings::ChannelConversionPings(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ChannelConversionPings::ChannelConversionPings(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const client::JsonCppArray<ChannelConversionPing > ChannelConversionPings::get_pings() const {
...
client::JsonCppArray<ChannelConversionPing > ChannelConversionPings::mutable_pings() {
