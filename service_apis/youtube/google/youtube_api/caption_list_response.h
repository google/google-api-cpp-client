...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_CAPTION_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_CAPTION_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class CaptionListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static CaptionListResponse* New();
   ...
   */
  explicit CaptionListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CaptionListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~CaptionListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::CaptionListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::CaptionListResponse");
  }
   ...
   */
  const client::JsonCppArray<Caption > get_items() const;
   ...
   */
  client::JsonCppArray<Caption > mutable_items();
 ...
 private:
  void operator=(const CaptionListResponse&);
};  // CaptionListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_CAPTION_LIST_RESPONSE_H_
