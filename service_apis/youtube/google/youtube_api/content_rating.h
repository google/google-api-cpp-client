...
class ContentRating : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>ecbmctRating</code>' attribute was set.
   *
   * @return true if the '<code>ecbmctRating</code>' attribute was set.
   */
  bool has_ecbmct_rating() const {
    return Storage().isMember("ecbmctRating");
  }

  /**
   * Clears the '<code>ecbmctRating</code>' attribute.
   */
  void clear_ecbmct_rating() {
    MutableStorage()->removeMember("ecbmctRating");
  }


  /**
   * Get the value of the '<code>ecbmctRating</code>' attribute.
   */
  const StringPiece get_ecbmct_rating() const {
    const Json::Value& v = Storage("ecbmctRating");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>ecbmctRating</code>' attribute.
   *
  ...
  void set_ecbmct_rating(const StringPiece& value) {
    *MutableStorage("ecbmctRating") = value.data();
  }
  ...
  /**
   * Determine if the '<code>fpbRatingReasons</code>' attribute was set.
   *
   * @return true if the '<code>fpbRatingReasons</code>' attribute was set.
   */
  bool has_fpb_rating_reasons() const {
    return Storage().isMember("fpbRatingReasons");
  }

  /**
   * Clears the '<code>fpbRatingReasons</code>' attribute.
   */
  void clear_fpb_rating_reasons() {
    MutableStorage()->removeMember("fpbRatingReasons");
  }


  /**
   * Get a reference to the value of the '<code>fpbRatingReasons</code>'
   * attribute.
   */
  const client::JsonCppArray<string > get_fpb_rating_reasons() const {
     const Json::Value& storage = Storage("fpbRatingReasons");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<string > >(storage);
  }

  /**
   * Gets a reference to a mutable value of the '<code>fpbRatingReasons</code>'
   * property.
   *
  ...
  client::JsonCppArray<string > mutable_fpbRatingReasons() {
    Json::Value* storage = MutableStorage("fpbRatingReasons");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<string > >(storage);
  }
  ...
  /**
   * Determine if the '<code>mcstRating</code>' attribute was set.
   *
   * @return true if the '<code>mcstRating</code>' attribute was set.
   */
  bool has_mcst_rating() const {
    return Storage().isMember("mcstRating");
  }

  /**
   * Clears the '<code>mcstRating</code>' attribute.
   */
  void clear_mcst_rating() {
    MutableStorage()->removeMember("mcstRating");
  }


  /**
   * Get the value of the '<code>mcstRating</code>' attribute.
   */
  const StringPiece get_mcst_rating() const {
    const Json::Value& v = Storage("mcstRating");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>mcstRating</code>' attribute.
   *
  ...
  void set_mcst_rating(const StringPiece& value) {
    *MutableStorage("mcstRating") = value.data();
  }
