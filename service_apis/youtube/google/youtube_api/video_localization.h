...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_VIDEO_LOCALIZATION_H_
#define  GOOGLE_YOUTUBE_API_VIDEO_LOCALIZATION_H_
 ...
 * @ingroup DataObject
 */
class VideoLocalization : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit VideoLocalization(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VideoLocalization(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::VideoLocalization</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::VideoLocalization");
  }
 ...
 private:
  void operator=(const VideoLocalization&);
};  // VideoLocalization
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_VIDEO_LOCALIZATION_H_
