...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_SEARCH_RESULT_H_
 ...
 * @ingroup DataObject
 */
class SearchResult : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit SearchResult(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SearchResult(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::SearchResult</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::SearchResult");
  }
   ...
   */
  const SearchResultSnippet get_snippet() const;
   ...
   * @return The result can be modified to change the attribute value.
   */
  SearchResultSnippet mutable_snippet();

 private:
  void operator=(const SearchResult&);
};  // SearchResult
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_SEARCH_RESULT_H_
