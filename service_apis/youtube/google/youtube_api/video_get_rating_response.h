...
class VideoGetRatingResponse : public client::JsonCppData {
 public:
  ...
  const client::JsonCppArray<VideoRating > get_items() const {
    ...
    return client::JsonValueToCppValueHelper<client::JsonCppArray<VideoRating > >(storage);
  }
  ...
  client::JsonCppArray<VideoRating > mutable_items() {
    ...
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<VideoRating > >(storage);
  }
