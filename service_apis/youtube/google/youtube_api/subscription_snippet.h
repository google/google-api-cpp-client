...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_SUBSCRIPTION_SNIPPET_H_
#define  GOOGLE_YOUTUBE_API_SUBSCRIPTION_SNIPPET_H_
 ...
 * @ingroup DataObject
 */
class SubscriptionSnippet : public client::JsonCppData {
 public:
  /**
   ...
   */
  static SubscriptionSnippet* New();
   ...
   */
  explicit SubscriptionSnippet(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit SubscriptionSnippet(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~SubscriptionSnippet();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::SubscriptionSnippet</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::SubscriptionSnippet");
  }
 ...
 private:
  void operator=(const SubscriptionSnippet&);
};  // SubscriptionSnippet
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_SUBSCRIPTION_SNIPPET_H_
