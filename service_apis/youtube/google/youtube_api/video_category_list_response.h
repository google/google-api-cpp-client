...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_VIDEO_CATEGORY_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_VIDEO_CATEGORY_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class VideoCategoryListResponse : public client::JsonCppData {
 public:
   ...
   */
  static VideoCategoryListResponse* New();
   ...
   */
  explicit VideoCategoryListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VideoCategoryListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~VideoCategoryListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::VideoCategoryListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::VideoCategoryListResponse");
  }
   ...
   */
  const client::JsonCppArray<VideoCategory > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<VideoCategory > >(storage);
  }
   ...
   */
  client::JsonCppArray<VideoCategory > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<VideoCategory > >(storage);
  }
 ...
 private:
  void operator=(const VideoCategoryListResponse&);
};  // VideoCategoryListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_VIDEO_CATEGORY_LIST_RESPONSE_H_
