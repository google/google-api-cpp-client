...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_ACTIVITY_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_ACTIVITY_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class ActivityListResponse : public client::JsonCppData {
 public:
   ...
   */
  static ActivityListResponse* New();
   ...
   */
  explicit ActivityListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ActivityListResponse(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::ActivityListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::ActivityListResponse");
  }
   ...
   */
  client::JsonCppArray<Activity > mutable_items() {
 ...
 private:
  void operator=(const ActivityListResponse&);
};  // ActivityListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_ACTIVITY_LIST_RESPONSE_H_
