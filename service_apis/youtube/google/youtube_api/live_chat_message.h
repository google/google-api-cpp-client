...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_LIVE_CHAT_MESSAGE_H_
#define  GOOGLE_YOUTUBE_API_LIVE_CHAT_MESSAGE_H_
 ...
 * @ingroup DataObject
 */
class LiveChatMessage : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit LiveChatMessage(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit LiveChatMessage(Json::Value* storage);
   ...
   *
   * @return <code>google_youtube_api::LiveChatMessage</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::LiveChatMessage");
  }

  /**
   * Determine if the '<code>authorDetails</code>' attribute was set.
   *
   * @return true if the '<code>authorDetails</code>' attribute was set.
   */
  bool has_author_details() const {
    return Storage().isMember("authorDetails");
  }

  /**
   * Clears the '<code>authorDetails</code>' attribute.
   */
  void clear_author_details() {
    MutableStorage()->removeMember("authorDetails");
  }


  /**
   * Get a reference to the value of the '<code>authorDetails</code>' attribute.
   */
  const LiveChatMessageAuthorDetails get_author_details() const;

  /**
   * Gets a reference to a mutable value of the '<code>authorDetails</code>'
   * property.
   *
 ...
 private:
  void operator=(const LiveChatMessage&);
};  // LiveChatMessage
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_LIVE_CHAT_MESSAGE_H_
