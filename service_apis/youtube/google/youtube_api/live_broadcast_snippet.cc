...
LiveBroadcastSnippet* LiveBroadcastSnippet::New() {
  return new client::JsonCppCapsule<LiveBroadcastSnippet>;
}

// Standard immutable constructor.
LiveBroadcastSnippet::LiveBroadcastSnippet(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
LiveBroadcastSnippet::LiveBroadcastSnippet(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const ThumbnailDetails LiveBroadcastSnippet::get_thumbnails() const {
   const Json::Value& storage = Storage("thumbnails");
   return client::JsonValueToCppValueHelper<ThumbnailDetails >(storage);
}

ThumbnailDetails LiveBroadcastSnippet::mutable_thumbnails() {
