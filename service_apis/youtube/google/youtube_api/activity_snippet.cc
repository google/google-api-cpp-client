...
ActivitySnippet* ActivitySnippet::New() {
  return new client::JsonCppCapsule<ActivitySnippet>;
}

// Standard immutable constructor.
ActivitySnippet::ActivitySnippet(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ActivitySnippet::ActivitySnippet(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const ThumbnailDetails ActivitySnippet::get_thumbnails() const {
   const Json::Value& storage = Storage("thumbnails");
   return client::JsonValueToCppValueHelper<ThumbnailDetails >(storage);
}

ThumbnailDetails ActivitySnippet::mutable_thumbnails() {
