...
class VideoConversionPings : public client::JsonCppData {
 public:
  ...
  const client::JsonCppArray<VideoConversionPing > get_pings() const {
    ...
    return client::JsonValueToCppValueHelper<client::JsonCppArray<VideoConversionPing > >(storage);
  }
  ...
  client::JsonCppArray<VideoConversionPing > mutable_pings() {
    ...
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<VideoConversionPing > >(storage);
  }
