...
PlaylistItemSnippet* PlaylistItemSnippet::New() {
  return new client::JsonCppCapsule<PlaylistItemSnippet>;
}

// Standard immutable constructor.
PlaylistItemSnippet::PlaylistItemSnippet(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
PlaylistItemSnippet::PlaylistItemSnippet(Json::Value* storage)
  : client::JsonCppData(storage) {
}
