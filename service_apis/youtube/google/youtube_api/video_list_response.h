...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_VIDEO_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_VIDEO_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class VideoListResponse : public client::JsonCppData {
 public:
   ...
   */
  explicit VideoListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit VideoListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~VideoListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::VideoListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::VideoListResponse");
  }
   ...
   */
  const client::JsonCppArray<Video > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<Video > >(storage);
  }
   ...
   */
  client::JsonCppArray<Video > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<Video > >(storage);
  }
 ...
 private:
  void operator=(const VideoListResponse&);
};  // VideoListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_VIDEO_LIST_RESPONSE_H_
