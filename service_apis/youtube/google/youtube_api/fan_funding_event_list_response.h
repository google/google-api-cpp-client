...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_FAN_FUNDING_EVENT_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_FAN_FUNDING_EVENT_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class FanFundingEventListResponse : public client::JsonCppData {
 public:
  /**
   ...
   */
  static FanFundingEventListResponse* New();
   ...
   */
  explicit FanFundingEventListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit FanFundingEventListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~FanFundingEventListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::FanFundingEventListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::FanFundingEventListResponse");
  }
   ...
   */
  const client::JsonCppArray<FanFundingEvent > get_items() const;
   ...
   */
  client::JsonCppArray<FanFundingEvent > mutable_items();
 ...
 private:
  void operator=(const FanFundingEventListResponse&);
};  // FanFundingEventListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_FAN_FUNDING_EVENT_LIST_RESPONSE_H_
