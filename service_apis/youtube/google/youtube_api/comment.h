...
//     C++: 0.1.3
#ifndef  GOOGLE_YOUTUBE_API_COMMENT_H_
#define  GOOGLE_YOUTUBE_API_COMMENT_H_
...
class Comment : public client::JsonCppData {
 public:
   ...
   *
   * @return <code>google_youtube_api::Comment</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::Comment");
  }
   ...
   */
  const CommentSnippet get_snippet() const;
   ...
   */
  CommentSnippet mutable_snippet();

 private:
  void operator=(const Comment&);
};  // Comment
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_COMMENT_H_
