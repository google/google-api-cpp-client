...
CommentListResponse* CommentListResponse::New() {
  return new client::JsonCppCapsule<CommentListResponse>;
}

// Standard immutable constructor.
CommentListResponse::CommentListResponse(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
CommentListResponse::CommentListResponse(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const client::JsonCppArray<Comment > CommentListResponse::get_items() const {
   const Json::Value& storage = Storage("items");
   return client::JsonValueToCppValueHelper<client::JsonCppArray<Comment > >(storage);
}

client::JsonCppArray<Comment > CommentListResponse::mutable_items() {
