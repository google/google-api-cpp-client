...
//     C++: 0.1.2
#ifndef  GOOGLE_YOUTUBE_API_PLAYLIST_LIST_RESPONSE_H_
#define  GOOGLE_YOUTUBE_API_PLAYLIST_LIST_RESPONSE_H_
 ...
 * @ingroup DataObject
 */
class PlaylistListResponse : public client::JsonCppData {
 public:
   ...
   */
  static PlaylistListResponse* New();
   ...
   */
  explicit PlaylistListResponse(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit PlaylistListResponse(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~PlaylistListResponse();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_youtube_api::PlaylistListResponse</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_youtube_api::PlaylistListResponse");
  }
   ...
   */
  const client::JsonCppArray<Playlist > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<Playlist > >(storage);
  }
   ...
   */
  client::JsonCppArray<Playlist > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<Playlist > >(storage);
  }
 ...
 private:
  void operator=(const PlaylistListResponse&);
};  // PlaylistListResponse
}  // namespace google_youtube_api
#endif  // GOOGLE_YOUTUBE_API_PLAYLIST_LIST_RESPONSE_H_
