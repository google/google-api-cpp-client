...
google_drive_api::ChildList* google_drive_api::ChildList::New() {
  return new client::JsonCppCapsule<ChildList>;
}

// Standard immutable constructor.
google_drive_api::ChildList::ChildList(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_drive_api::ChildList::ChildList(Json::Value* storage)
  : client::JsonCppData(storage) {
}

// Standard destructor.
google_drive_api::ChildList::~ChildList() {
}
}  // namespace google_drive_api
