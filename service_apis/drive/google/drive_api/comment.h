...
class Comment : public client::JsonCppData {
 public:
   ...
   */
  User mutable_author() {
    return User(MutableStorage("author"));
  }
   ...
   */
  const StringPiece get_commentId() const {
   ...
   * @param[in] value The new value.
   */
  void set_commentId(const StringPiece& value) {
  ...
  const CommentContext get_context() const {
    return CommentContext(Storage("context"));
  }
  ...
  CommentContext mutable_context() {
    return CommentContext(MutableStorage("context"));
  }
   ...
   */
  const StringPiece get_fileId() const {
   ...
   * @param[in] value The new value.
   */
  void set_fileId(const StringPiece& value) {
   ...
   */
  const StringPiece get_fileTitle() const {
   ...
   * @param[in] value The new value.
   */
  void set_fileTitle(const StringPiece& value) {
   ...
   */
  const StringPiece get_htmlContent() const {
   ...
   * @param[in] value The new value.
   */
  void set_htmlContent(const StringPiece& value) {
  ...
  const client::JsonCppArray<CommentReply > get_replies() const {
    return client::JsonCppArray<CommentReply >(Storage("replies"));
  }
  ...
  client::JsonCppArray<CommentReply > mutable_replies() {
    return client::JsonCppArray<CommentReply >(MutableStorage("replies"));
  }
