...
google_drive_api::AppList* google_drive_api::AppList::New() {
  return new client::JsonCppCapsule<AppList>;
}

// Standard immutable constructor.
google_drive_api::AppList::AppList(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_drive_api::AppList::AppList(Json::Value* storage)
  : client::JsonCppData(storage) {
}

// Standard destructor.
google_drive_api::AppList::~AppList() {
}
}  // namespace google_drive_api
