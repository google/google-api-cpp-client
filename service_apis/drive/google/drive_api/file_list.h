...
class FileList : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>incompleteSearch</code>' attribute was set.
   *
   * @return true if the '<code>incompleteSearch</code>' attribute was set.
   */
  bool has_incomplete_search() const {
    return Storage().isMember("incompleteSearch");
  }

  /**
   * Clears the '<code>incompleteSearch</code>' attribute.
   */
  void clear_incomplete_search() {
    MutableStorage()->removeMember("incompleteSearch");
  }


  /**
   * Get the value of the '<code>incompleteSearch</code>' attribute.
   */
  bool get_incomplete_search() const {
    const Json::Value& storage = Storage("incompleteSearch");
    return client::JsonValueToCppValueHelper<bool >(storage);
  }

  /**
   * Change the '<code>incompleteSearch</code>' attribute.
   *
  ...
  void set_incomplete_search(bool value) {
    client::SetJsonValueFromCppValueHelper<bool >(
      value, MutableStorage("incompleteSearch"));
  }
