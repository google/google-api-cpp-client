...
//     C++: 0.1
#ifndef  GOOGLE_DRIVE_API_PARENT_LIST_H_
#define  GOOGLE_DRIVE_API_PARENT_LIST_H_
 ...
 * @ingroup DataObject
 */
class ParentList : public client::JsonCppData {
 public:
   ...
   */
  explicit ParentList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ParentList(Json::Value* storage);
   ...
   *
   * @return <code>google_drive_api::ParentList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_drive_api::ParentList");
  }
  ...
  const client::JsonCppArray<ParentReference > get_items() const {
    return client::JsonCppArray<ParentReference >(Storage("items"));
  }
  ...
  client::JsonCppArray<ParentReference > mutable_items() {
    return client::JsonCppArray<ParentReference >(MutableStorage("items"));
  }
 ...
 private:
  void operator=(const ParentList&);
};  // ParentList
}  // namespace google_drive_api
#endif  // GOOGLE_DRIVE_API_PARENT_LIST_H_
