...
class ChangesResource_GetMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~ChangesResource_GetMethod();
    ...
    /**
     * Clears the '<code>supportsTeamDrives</code>' attribute so it is no longer
     * set.
     */
    void clear_supports_team_drives() {
      _have_supports_team_drives_ = false;
      client::ClearCppValueHelper(&supports_team_drives_);
    }


    /**
     * Gets the optional '<code>supportsTeamDrives</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    bool get_supports_team_drives() const { return supports_team_drives_; }

    /**
     * Sets the '<code>supportsTeamDrives</code>' attribute.
     *
     * @param[in] value Whether the requesting application supports Team Drives.
     */
    void set_supports_team_drives(bool value) {
      _have_supports_team_drives_ = true;
      supports_team_drives_ = value;
    }

    /**
     * Clears the '<code>teamDriveId</code>' attribute so it is no longer set.
     */
    void clear_team_drive_id() {
      _have_team_drive_id_ = false;
      client::ClearCppValueHelper(&team_drive_id_);
    }


    /**
     * Gets the optional '<code>teamDriveId</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    const string& get_team_drive_id() const { return team_drive_id_; }

    /**
     * Gets a modifiable pointer to the optional <code>teamDriveId</code>'
     * attribute.
     *
     * @return  The value can be set by dereferencing the pointer.
     */
    string* mutable_teamDriveId() {
      _have_team_drive_id_ = true;
      return &team_drive_id_;
    }


    /**
     * Sets the '<code>teamDriveId</code>' attribute.
     *
     * @param[in] value The Team Drive from which the change will be returned.
     */
    void set_team_drive_id(const string& value) {
      _have_team_drive_id_ = true;
      team_drive_id_ = value;
    }
 ...
 private:
  string change_id_;
  bool supports_team_drives_;
  string team_drive_id_;
  bool _have_supports_team_drives_ : 1;
  bool _have_team_drive_id_ : 1;
...
class ChangesResource_GetStartPageTokenMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~ChangesResource_GetStartPageTokenMethod();
     ...
     * Sets the '<code>teamDriveId</code>' attribute.
     *
     * @param[in] value The ID of the Team Drive for which the starting
     * pageToken for listing future changes from that Team Drive will be
     * returned.
     */
    void set_team_drive_id(const string& value) {
      _have_team_drive_id_ = true;
...
class ChangesResource_ListMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~ChangesResource_ListMethod();
    ...
    /**
     * Clears the '<code>includeCorpusRemovals</code>' attribute so it is no
     * longer set.
     */
    void clear_include_corpus_removals() {
      _have_include_corpus_removals_ = false;
      client::ClearCppValueHelper(&include_corpus_removals_);
    }


    /**
     * Gets the optional '<code>includeCorpusRemovals</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    bool get_include_corpus_removals() const { return include_corpus_removals_; }

    /**
     * Sets the '<code>includeCorpusRemovals</code>' attribute.
     *
     * @param[in] value Whether changes should include the file resource if the
     * file is still accessible by the user at the time of the request, even
     * when a file was removed from the list of changes and there will be no
     * further change entries for this file.
     */
    void set_include_corpus_removals(bool value) {
      _have_include_corpus_removals_ = true;
      include_corpus_removals_ = value;
    }
    ...
    /**
     * Clears the '<code>includeTeamDriveItems</code>' attribute so it is no
     * longer set.
     */
    void clear_include_team_drive_items() {
      _have_include_team_drive_items_ = false;
      client::ClearCppValueHelper(&include_team_drive_items_);
    }


    /**
     * Gets the optional '<code>includeTeamDriveItems</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    bool get_include_team_drive_items() const { return include_team_drive_items_; }

    /**
     * Sets the '<code>includeTeamDriveItems</code>' attribute.
     *
     * @param[in] value Whether Team Drive files or changes should be included
     * in results.
     */
    void set_include_team_drive_items(bool value) {
      _have_include_team_drive_items_ = true;
      include_team_drive_items_ = value;
    }
     ...
     * Sets the '<code>teamDriveId</code>' attribute.
     *
     * @param[in] value The Team Drive from which changes will be returned. If
 ...
 private:
  bool include_corpus_removals_;
  bool include_deleted_;
  bool include_subscribed_;
  bool include_team_drive_items_;
  int32 max_results_;
  string page_token_;
  string spaces_;
  int64 start_change_id_;
  bool supports_team_drives_;
  string team_drive_id_;
  bool _have_include_corpus_removals_ : 1;
  bool _have_include_deleted_ : 1;
  bool _have_include_subscribed_ : 1;
  bool _have_include_team_drive_items_ : 1;
...
class ChangesResource_WatchMethod : public DriveServiceBaseRequest {
 ...
 private:
  ...
  bool _have_start_change_id_ : 1;
  bool _have_supports_team_drives_ : 1;
  bool _have_team_drive_id_ : 1;  string _content_;
...
class ChildrenResource_InsertMethod : public DriveServiceBaseRequest {
 ...
 private:
  string folder_id_;
  bool supports_team_drives_;
  bool _have_supports_team_drives_ : 1;  string _content_;
...
class FilesResource_GetMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~FilesResource_GetMethod();
    ...
    /**
     * Clears the '<code>revisionId</code>' attribute so it is no longer set.
     */
    void clear_revision_id() {
      _have_revision_id_ = false;
      client::ClearCppValueHelper(&revision_id_);
    }


    /**
     * Gets the optional '<code>revisionId</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    const string& get_revision_id() const { return revision_id_; }

    /**
     * Gets a modifiable pointer to the optional <code>revisionId</code>'
     * attribute.
     *
     * @return  The value can be set by dereferencing the pointer.
     */
    string* mutable_revisionId() {
      _have_revision_id_ = true;
      return &revision_id_;
    }


    /**
     * Sets the '<code>revisionId</code>' attribute.
     *
     * @param[in] value Specifies the Revision ID that should be downloaded.
...
class FilesResource_ListMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~FilesResource_ListMethod();
    ...
    /**
     * Clears the '<code>corpora</code>' attribute so it is no longer set.
     */
    void clear_corpora() {
      _have_corpora_ = false;
      client::ClearCppValueHelper(&corpora_);
    }


    /**
     * Gets the optional '<code>corpora</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    const string& get_corpora() const { return corpora_; }

    /**
     * Gets a modifiable pointer to the optional <code>corpora</code>'
     * attribute.
     *
     * @return  The value can be set by dereferencing the pointer.
     */
    ...
    /**
     * Sets the '<code>corpora</code>' attribute.
     *
     * @param[in] value Comma-separated list of bodies of items
     ...
     * Sets the '<code>includeTeamDriveItems</code>' attribute.
     *
     * @param[in] value Whether Team Drive items should be included in results.
     */
    void set_include_team_drive_items(bool value) {
      _have_include_team_drive_items_ = true;
      include_team_drive_items_ = value;
     ...
     * Sets the '<code>maxResults</code>' attribute.
     *
     * @param[in] value The maximum number of files to return per page. Partial
     * or empty result pages are possible even before the end of the files list
     * has been reached.
     */
    void set_max_results(int32 value) {
      _have_max_results_ = true;
     ...
     * Sets the '<code>teamDriveId</code>' attribute.
     *
     * @param[in] value ID of Team Drive to search.
     */
    void set_team_drive_id(const string& value) {
      _have_team_drive_id_ = true;
      team_drive_id_ = value;
...
class FilesResource_PatchMethod : public DriveServiceBaseRequest {
 ...
 private:
  ...
  bool _have_timed_text_track_name_ : 1;
  bool _have_update_viewed_date_ : 1;
  bool _have_use_content_as_indexable_text_ : 1;  string _content_;
...
class FilesResource_WatchMethod : public DriveServiceBaseRequest {
 ...
 private:
  ...
  bool _have_revision_id_ : 1;
  bool _have_supports_team_drives_ : 1;
  bool _have_update_viewed_date_ : 1;  string _content_;
...
class PermissionsResource_DeleteMethod : public DriveServiceBaseRequest {
 public:
   ...
   *            In practice this is supplied by the user code that is
   *            creating the method instance.
   * @param[in] file_id The ID for the file or Team Drive.
...
class PermissionsResource_InsertMethod : public DriveServiceBaseRequest {
 ...
 private:
  ...
  bool _have_send_notification_emails_ : 1;
  bool _have_supports_team_drives_ : 1;  string _content_;
...
class PermissionsResource_ListMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~PermissionsResource_ListMethod();
     ...
     * Sets the '<code>maxResults</code>' attribute.
     *
     * @param[in] value The maximum number of permissions to return per page.
     * When not set for files in a Team Drive, at most 100 results will be
     * returned. When not set for files that are not in a Team Drive, the entire
...
typedef client::ServiceRequestPager<
            PermissionsResource_ListMethod,
            PermissionList>
        PermissionsResource_ListMethodPager;
...
class PermissionsResource_PatchMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~PermissionsResource_PatchMethod();
    ...
    /**
     * Clears the '<code>removeExpiration</code>' attribute so it is no longer
     * set.
     */
    void clear_remove_expiration() {
      _have_remove_expiration_ = false;
      client::ClearCppValueHelper(&remove_expiration_);
    }


    /**
     * Gets the optional '<code>removeExpiration</code>' attribute.
     *
     * If the value is not set then the default value will be returned.
     */
    bool get_remove_expiration() const { return remove_expiration_; }

    /**
     * Sets the '<code>removeExpiration</code>' attribute.
     *
     * @param[in] value Whether to remove the expiration date.
     */
    void set_remove_expiration(bool value) {
      _have_remove_expiration_ = true;
      remove_expiration_ = value;
    }
     ...
     *
     * @param[in] value Whether changing a role to 'owner' downgrades the
 ...
 private:
  string file_id_;
  string permission_id_;
  bool remove_expiration_;
  bool supports_team_drives_;
  bool transfer_ownership_;
  bool _have_remove_expiration_ : 1;
  bool _have_supports_team_drives_ : 1;
...
class RevisionsResource_ListMethod : public DriveServiceBaseRequest {
 public:
  ...
  virtual ~RevisionsResource_ListMethod();
     ...
     * Sets the '<code>maxResults</code>' attribute.
     *
     * @param[in] value Maximum number of revisions to return.
     */
    void set_max_results(int32 value) {
      _have_max_results_ = true;
      max_results_ = value;
     ...
     * Sets the '<code>pageToken</code>' attribute.
     *
     * @param[in] value Page token for revisions. To get the next page of
...
typedef client::ServiceRequestPager<
            RevisionsResource_ListMethod,
            RevisionList>
        RevisionsResource_ListMethodPager;
 ...
 * https://www.googleapis.com/auth/drive
 */
class TeamdrivesResource_DeleteMethod : public DriveServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   *            In practice this is supplied by the user code that is
   *            creating the method instance.
   * @param[in] team_drive_id The ID of the Team Drive.
   */
  TeamdrivesResource_DeleteMethod(
      const DriveService* _service_,
      client::AuthorizationCredential* _credential_,
      const StringPiece& team_drive_id);

  /**
   * Standard destructor.
   */
  virtual ~TeamdrivesResource_DeleteMethod();
 ...
 private:
  string team_drive_id_;
  DISALLOW_COPY_AND_ASSIGN(TeamdrivesResource_DeleteMethod);
};
 ...
 * https://www.googleapis.com/auth/drive.readonly
 */
class TeamdrivesResource_GetMethod : public DriveServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * Standard destructor.
   */
  virtual ~TeamdrivesResource_GetMethod();
 ...
 private:
  string team_drive_id_;
  DISALLOW_COPY_AND_ASSIGN(TeamdrivesResource_GetMethod);
};
 ...
 * https://www.googleapis.com/auth/drive
 */
class TeamdrivesResource_InsertMethod : public DriveServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   *            In practice this is supplied by the user code that is
   *            creating the method instance.
   * @param[in] request_id An ID, such as a random UUID, which uniquely
 ...
 private:
  string request_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(TeamdrivesResource_InsertMethod);
};
 ...
 * https://www.googleapis.com/auth/drive.readonly
 */
class TeamdrivesResource_ListMethod : public DriveServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * Standard destructor.
   */
  virtual ~TeamdrivesResource_ListMethod();
     ...
     * Sets the '<code>maxResults</code>' attribute.
     *
     * @param[in] value Maximum number of Team Drives to return.
     */
    void set_max_results(int32 value) {
      _have_max_results_ = true;
      max_results_ = value;
     ...
     * Sets the '<code>pageToken</code>' attribute.
     *
     * @param[in] value Page token for Team Drives.
     */
    void set_page_token(const string& value) {
      _have_page_token_ = true;
      page_token_ = value;
 ...
 private:
  ...
  bool _have_max_results_ : 1;
  bool _have_page_token_ : 1;
  DISALLOW_COPY_AND_ASSIGN(TeamdrivesResource_ListMethod);
};

typedef client::ServiceRequestPager<
            TeamdrivesResource_ListMethod,
            TeamDriveList>
        TeamdrivesResource_ListMethodPager;
 ...
 * https://www.googleapis.com/auth/drive
 */
class TeamdrivesResource_UpdateMethod : public DriveServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * @param[in] _content_ The data object to update.
   */
  TeamdrivesResource_UpdateMethod(
      const DriveService* _service_,
      client::AuthorizationCredential* _credential_,
      const StringPiece& team_drive_id,
      const TeamDrive& _content_);
   ...
   * Standard destructor.
   */
  virtual ~TeamdrivesResource_UpdateMethod();
 ...
 private:
  string team_drive_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(TeamdrivesResource_UpdateMethod);
};
...
class DriveService : public client::ClientService {
 public:
  ...
  class AppsResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit AppsResource(DriveService* service);
  ...
  class ChildrenResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit ChildrenResource(DriveService* service);
  ...
  class ParentsResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit ParentsResource(DriveService* service);
  ...
  class PermissionsResource {
   public:
     ...
     * @see googleapis::googleapis::ServiceRequestPager
     */
    PermissionsResource_ListMethodPager* NewListMethodPager(
        client::AuthorizationCredential* _credential_,
        const StringPiece& file_id) const;
  ...
  class PropertiesResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit PropertiesResource(DriveService* service);
  ...
  class RealtimeResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit RealtimeResource(DriveService* service);
  ...
  class RevisionsResource {
   public:
     ...
     * @see googleapis::googleapis::ServiceRequestPager
     */
    RevisionsResource_ListMethodPager* NewListMethodPager(
        client::AuthorizationCredential* _credential_,
        const StringPiece& file_id) const;
  ...
  class TeamdrivesResource {
   public:
     ...
     *            the service that methods are invoked on.
     */
    explicit TeamdrivesResource(DriveService* service);
     ...
     *           then destroy it when they are finished.
     */
    TeamdrivesResource_DeleteMethod* NewDeleteMethod(
        client::AuthorizationCredential* _credential_,
        const StringPiece& team_drive_id) const;
     ...
     *           then destroy it when they are finished.
     */
    TeamdrivesResource_GetMethod* NewGetMethod(
        client::AuthorizationCredential* _credential_,
        const StringPiece& team_drive_id) const;
     ...
     *           then destroy it when they are finished.
     */
    TeamdrivesResource_InsertMethod* NewInsertMethod(
        client::AuthorizationCredential* _credential_,
        const StringPiece& request_id,
        const TeamDrive& _content_) const;
     ...
     *           then destroy it when they are finished.
     */
    TeamdrivesResource_ListMethod* NewListMethod(
        client::AuthorizationCredential* _credential_) const;
     ...
     * @see googleapis::googleapis::ServiceRequestPager
     */
    TeamdrivesResource_ListMethodPager* NewListMethodPager(
        client::AuthorizationCredential* _credential_) const;
     ...
     *           then destroy it when they are finished.
     */
    TeamdrivesResource_UpdateMethod* NewUpdateMethod(
        client::AuthorizationCredential* _credential_,
        const StringPiece& team_drive_id,
        const TeamDrive& _content_) const;
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(TeamdrivesResource);
  };
   ...
   * Gets the  resource method factory.
   *
   * @return TeamdrivesResource for creating methods.
   */
  ...
  class SCOPES {
   public:
     ...
     */
    static const char DRIVE_APPS_READONLY[];
 ...
 private:
  ...
  TeamdrivesResource teamdrives_;
