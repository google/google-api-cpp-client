...
//     C++: 0.1
#ifndef  GOOGLE_DRIVE_API_COMMENT_REPLY_LIST_H_
#define  GOOGLE_DRIVE_API_COMMENT_REPLY_LIST_H_
 ...
 * @ingroup DataObject
 */
class CommentReplyList : public client::JsonCppData {
 public:
   ...
   */
  explicit CommentReplyList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit CommentReplyList(Json::Value* storage);

  /**
   * Standard destructor.
   */
  virtual ~CommentReplyList();

  /**
   * Returns a string denoting the type of this data object.
   *
   * @return <code>google_drive_api::CommentReplyList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_drive_api::CommentReplyList");
  }
   ...
   */
  const client::JsonCppArray<CommentReply > get_items() const {
    return client::JsonCppArray<CommentReply >(Storage("items"));
  }
   ...
   */
  client::JsonCppArray<CommentReply > mutable_items() {
    return client::JsonCppArray<CommentReply >(MutableStorage("items"));
  }
   ...
   */
  const StringPiece get_nextLink() const {
   ...
   * @param[in] value The new value.
   */
  void set_nextLink(const StringPiece& value) {
   ...
   */
  const StringPiece get_nextPageToken() const {
   ...
   * @param[in] value The new value.
   */
  void set_nextPageToken(const StringPiece& value) {
 ...
 private:
  void operator=(const CommentReplyList&);
};  // CommentReplyList
}  // namespace google_drive_api
#endif  // GOOGLE_DRIVE_API_COMMENT_REPLY_LIST_H_
