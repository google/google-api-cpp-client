...
class Change : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>teamDrive</code>' attribute was set.
   *
   * @return true if the '<code>teamDrive</code>' attribute was set.
   */
  bool has_team_drive() const {
    return Storage().isMember("teamDrive");
  }

  /**
   * Clears the '<code>teamDrive</code>' attribute.
   */
  void clear_team_drive() {
    MutableStorage()->removeMember("teamDrive");
  }


  /**
   * Get a reference to the value of the '<code>teamDrive</code>' attribute.
   */
  const TeamDrive get_team_drive() const;

  /**
   * Gets a reference to a mutable value of the '<code>teamDrive</code>'
   * property.
   *
