...
class Change : public client::JsonCppData {
 public:
   ...
   */
  File mutable_file() {
    return File(MutableStorage("file"));
  }
   ...
   */
  bool has_modificationDate() const {
   ...
   */
  client::DateTime get_modificationDate() const {
   ...
   * @param[in] value The new value.
   */
  void set_modificationDate(client::DateTime value) {
