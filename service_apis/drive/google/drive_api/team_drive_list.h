...
//     C++: 0.1.4
#ifndef  GOOGLE_DRIVE_API_TEAM_DRIVE_LIST_H_
#define  GOOGLE_DRIVE_API_TEAM_DRIVE_LIST_H_
 ...
 * @ingroup DataObject
 */
class TeamDriveList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit TeamDriveList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit TeamDriveList(Json::Value* storage);
   ...
   *
   * @return <code>google_drive_api::TeamDriveList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_drive_api::TeamDriveList");
  }
   ...
   */
  const client::JsonCppArray<TeamDrive > get_items() const;
   ...
   */
  client::JsonCppArray<TeamDrive > mutable_items();
 ...
 private:
  void operator=(const TeamDriveList&);
};  // TeamDriveList
}  // namespace google_drive_api
#endif  // GOOGLE_DRIVE_API_TEAM_DRIVE_LIST_H_
