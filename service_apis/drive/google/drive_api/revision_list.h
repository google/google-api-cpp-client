...
//     C++: 0.1.2
#ifndef  GOOGLE_DRIVE_API_REVISION_LIST_H_
#define  GOOGLE_DRIVE_API_REVISION_LIST_H_
 ...
 * @ingroup DataObject
 */
class RevisionList : public client::JsonCppData {
 public:
   ...
   */
  explicit RevisionList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit RevisionList(Json::Value* storage);
   ...
   *
   * @return <code>google_drive_api::RevisionList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_drive_api::RevisionList");
  }
   ...
   */
  const client::JsonCppArray<Revision > get_items() const {
     const Json::Value& storage = Storage("items");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<Revision > >(storage);
  }
   ...
   */
  client::JsonCppArray<Revision > mutable_items() {
    Json::Value* storage = MutableStorage("items");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<Revision > >(storage);
  }
 ...
 private:
  void operator=(const RevisionList&);
};  // RevisionList
}  // namespace google_drive_api
#endif  // GOOGLE_DRIVE_API_REVISION_LIST_H_
