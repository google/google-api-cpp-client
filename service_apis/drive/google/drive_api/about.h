...
class About : public client::JsonCppData {
 public:
   ...
   * @ingroup DataObject
   */
  class AboutTeamDriveThemes : public client::JsonCppData {
   public:
    /**
     * Creates a new default instance.
     *
     * @return Ownership is passed back to the caller.
     */
    static AboutTeamDriveThemes* New();
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit AboutTeamDriveThemes(const Json::Value& storage);
     ...
     * @param[in] storage  The underlying data storage for this instance.
     */
    explicit AboutTeamDriveThemes(Json::Value* storage);
     ...
     * Returns a string denoting the type of this data object.
     *
     * @return <code>google_drive_api::AboutTeamDriveThemes</code>
     */
    const StringPiece GetTypeName() const {
      return StringPiece("google_drive_api::AboutTeamDriveThemes");
    }
   ...
   private:
    void operator=(const AboutTeamDriveThemes&);
  ...
  /**
   * Determine if the '<code>teamDriveThemes</code>' attribute was set.
   *
   * @return true if the '<code>teamDriveThemes</code>' attribute was set.
   */
  bool has_team_drive_themes() const {
    return Storage().isMember("teamDriveThemes");
  }

  /**
   * Clears the '<code>teamDriveThemes</code>' attribute.
   */
  void clear_team_drive_themes() {
    MutableStorage()->removeMember("teamDriveThemes");
  }


  /**
   * Get a reference to the value of the '<code>teamDriveThemes</code>'
   * attribute.
   */
  const client::JsonCppArray<AboutTeamDriveThemes > get_team_drive_themes() const {
     const Json::Value& storage = Storage("teamDriveThemes");
    return client::JsonValueToCppValueHelper<client::JsonCppArray<AboutTeamDriveThemes > >(storage);
  }

  /**
   * Gets a reference to a mutable value of the '<code>teamDriveThemes</code>'
   * property.
   *
  ...
  client::JsonCppArray<AboutTeamDriveThemes > mutable_teamDriveThemes() {
    Json::Value* storage = MutableStorage("teamDriveThemes");
    return client::JsonValueToMutableCppValueHelper<client::JsonCppArray<AboutTeamDriveThemes > >(storage);
  }
