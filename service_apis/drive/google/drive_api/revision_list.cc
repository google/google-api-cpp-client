...
google_drive_api::RevisionList* google_drive_api::RevisionList::New() {
  return new client::JsonCppCapsule<RevisionList>;
}

// Standard immutable constructor.
google_drive_api::RevisionList::RevisionList(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_drive_api::RevisionList::RevisionList(Json::Value* storage)
  : client::JsonCppData(storage) {
}

// Standard destructor.
google_drive_api::RevisionList::~RevisionList() {
}
}  // namespace google_drive_api
