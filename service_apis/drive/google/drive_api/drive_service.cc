...
const char DriveService::googleapis_API_VERSION[] = {"v2"};
...
const char DriveService::SCOPES::DRIVE_APPS_READONLY[] = {"https://www.googleapis.com/auth/drive.apps.readonly"};
...
ChangesResource_GetMethod::ChangesResource_GetMethod(
    ...
    : DriveServiceBaseRequest(
      ...
      supports_team_drives_(false),
      _have_supports_team_drives_(false),
      _have_team_drive_id_(false) {
}
...
util::Status ChangesResource_GetMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
                supports_team_drives_));
    sep = "&";
  }
  if (_have_team_drive_id_) {
    StrAppend(target, sep, "teamDriveId=",
              client::CppValueToEscapedUrlValue(
                team_drive_id_));
    sep = "&";
  }
...
util::Status ChangesResource_GetStartPageTokenMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status ChangesResource_GetStartPageTokenMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  return DriveServiceBaseRequest::AppendVariable(
...
ChangesResource_ListMethod::ChangesResource_ListMethod(
    ...
    : DriveServiceBaseRequest(
        ...
        client::HttpRequest::GET,
        "changes"),
      include_corpus_removals_(false),
      include_deleted_(true),
      include_subscribed_(true),
      include_team_drive_items_(false),
      max_results_(100),
      supports_team_drives_(false),
      _have_include_corpus_removals_(false),
      _have_include_deleted_(false),
      _have_include_subscribed_(false),
      _have_include_team_drive_items_(false),
...
util::Status ChangesResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_include_corpus_removals_) {
    StrAppend(target, sep, "includeCorpusRemovals=",
              client::CppValueToEscapedUrlValue(
                include_corpus_removals_));
    sep = "&";
  }
  ...
  if (_have_include_team_drive_items_) {
    StrAppend(target, sep, "includeTeamDriveItems=",
              client::CppValueToEscapedUrlValue(
                include_team_drive_items_));
    sep = "&";
  }
...
util::Status ChildrenResource_DeleteMethod::AppendVariable(
  ...
  if (variable_name == "folderId") {
    client::UriTemplate::AppendValue(
        folder_id_, config, target);
    return client::StatusOk();
  }
  if (variable_name == "childId") {
    client::UriTemplate::AppendValue(
        child_id_, config, target);
    return client::StatusOk();
  }
  return DriveServiceBaseRequest::AppendVariable(
      variable_name, config, target);
...
util::Status ChildrenResource_InsertMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status FilesResource_DeleteMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status FilesResource_GetMethod::AppendOptionalQueryParameters(string* target) {
  ...
  if (_have_revision_id_) {
    StrAppend(target, sep, "revisionId=",
              client::CppValueToEscapedUrlValue(
                revision_id_));
    sep = "&";
  }
...
util::Status FilesResource_TouchMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status FilesResource_TrashMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status FilesResource_UntrashMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status ParentsResource_InsertMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status PermissionsResource_DeleteMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status PermissionsResource_GetMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_supports_team_drives_) {
    StrAppend(target, sep, "supportsTeamDrives=",
              client::CppValueToEscapedUrlValue(
...
util::Status PermissionsResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_max_results_) {
    StrAppend(target, sep, "maxResults=",
              client::CppValueToEscapedUrlValue(
...
PermissionsResource_PatchMethod::PermissionsResource_PatchMethod(
    ...
    : DriveServiceBaseRequest(
      ...
      file_id_(file_id.as_string()),
      permission_id_(permission_id.as_string()),
      remove_expiration_(false),
      supports_team_drives_(false),
      transfer_ownership_(false),
      _have_remove_expiration_(false),
      _have_supports_team_drives_(false),
...
util::Status PermissionsResource_PatchMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_remove_expiration_) {
    StrAppend(target, sep, "removeExpiration=",
              client::CppValueToEscapedUrlValue(
                remove_expiration_));
    sep = "&";
  }
...
util::Status RevisionsResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_max_results_) {
    StrAppend(target, sep, "maxResults=",
              client::CppValueToEscapedUrlValue(
...
// Standard constructor.
TeamdrivesResource_DeleteMethod::TeamdrivesResource_DeleteMethod(
    const DriveService* _service_, client::AuthorizationCredential* _credential_, const StringPiece& team_drive_id)
    : DriveServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::DELETE,
        "teamdrives/{teamDriveId}"),
      team_drive_id_(team_drive_id.as_string()) {
}
...
util::Status TeamdrivesResource_DeleteMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "teamDriveId") {
    client::UriTemplate::AppendValue(
        team_drive_id_, config, target);
    return client::StatusOk();
  }
  return DriveServiceBaseRequest::AppendVariable(
      variable_name, config, target);
...
util::Status TeamdrivesResource_GetMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "teamDriveId") {
...
TeamdrivesResource_InsertMethod::TeamdrivesResource_InsertMethod(
    const DriveService* _service_, client::AuthorizationCredential* _credential_, const StringPiece& request_id, const TeamDrive& __request_content__)
    : DriveServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
        "teamdrives"),
      request_id_(request_id.as_string()) {
  AddJsonContentToRequest(&__request_content__);
}
...
util::Status TeamdrivesResource_InsertMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
    StrAppend(target, sep, "requestId=",
              client::CppValueToEscapedUrlValue(
                request_id_));
    sep = "&";
  return DriveServiceBaseRequest::AppendOptionalQueryParameters(target);
}
util::Status TeamdrivesResource_InsertMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  return DriveServiceBaseRequest::AppendVariable(
...
// Standard constructor.
TeamdrivesResource_ListMethod::TeamdrivesResource_ListMethod(
    const DriveService* _service_, client::AuthorizationCredential* _credential_)
    : DriveServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
util::Status TeamdrivesResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_max_results_) {
    StrAppend(target, sep, "maxResults=",
              client::CppValueToEscapedUrlValue(
...
util::Status TeamdrivesResource_ListMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  return DriveServiceBaseRequest::AppendVariable(
...
TeamdrivesResource_UpdateMethod::TeamdrivesResource_UpdateMethod(
    const DriveService* _service_, client::AuthorizationCredential* _credential_, const StringPiece& team_drive_id, const TeamDrive& __request_content__)
    : DriveServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "teamdrives/{teamDriveId}"),
...
DriveService::DriveService(client::HttpTransport* transport)
  : ClientService("https://www.googleapis.com/", "drive/v2/", transport), about_(this), apps_(this), changes_(this), channels_(this), children_(this), comments_(this), files_(this), parents_(this), permissions_(this), properties_(this), realtime_(this), replies_(this), revisions_(this), teamdrives_(this) {
}
...
PermissionsResource_ListMethodPager* DriveService::PermissionsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const StringPiece& file_id) const {
  return new client::EncapsulatedServiceRequestPager<PermissionsResource_ListMethod, PermissionList>(new PermissionsResource_ListMethod(service_, _credential_, file_id));
}
...
RevisionsResource_ListMethodPager* DriveService::RevisionsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const StringPiece& file_id) const {
  return new client::EncapsulatedServiceRequestPager<RevisionsResource_ListMethod, RevisionList>(new RevisionsResource_ListMethod(service_, _credential_, file_id));
}
...
DriveService::TeamdrivesResource::TeamdrivesResource(DriveService* service)
  : service_(service) {
}



TeamdrivesResource_DeleteMethod* DriveService::TeamdrivesResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const StringPiece& team_drive_id) const {
  return new TeamdrivesResource_DeleteMethod(service_, _credential_, team_drive_id);
}


TeamdrivesResource_GetMethod* DriveService::TeamdrivesResource::NewGetMethod(client::AuthorizationCredential* _credential_, const StringPiece& team_drive_id) const {
  return new TeamdrivesResource_GetMethod(service_, _credential_, team_drive_id);
}


TeamdrivesResource_InsertMethod* DriveService::TeamdrivesResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const StringPiece& request_id, const TeamDrive& __request_content__) const {
  return new TeamdrivesResource_InsertMethod(service_, _credential_, request_id, __request_content__);
}


TeamdrivesResource_ListMethod* DriveService::TeamdrivesResource::NewListMethod(client::AuthorizationCredential* _credential_) const {
  return new TeamdrivesResource_ListMethod(service_, _credential_);
}


TeamdrivesResource_ListMethodPager* DriveService::TeamdrivesResource::NewListMethodPager(client::AuthorizationCredential* _credential_) const {
  return new client::EncapsulatedServiceRequestPager<TeamdrivesResource_ListMethod, TeamDriveList>(new TeamdrivesResource_ListMethod(service_, _credential_));
}


TeamdrivesResource_UpdateMethod* DriveService::TeamdrivesResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const StringPiece& team_drive_id, const TeamDrive& __request_content__) const {
  return new TeamdrivesResource_UpdateMethod(service_, _credential_, team_drive_id, __request_content__);
}
}  // namespace google_drive_api
