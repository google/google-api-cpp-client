...
google_drive_api::CommentList* google_drive_api::CommentList::New() {
  return new client::JsonCppCapsule<CommentList>;
}

// Standard immutable constructor.
google_drive_api::CommentList::CommentList(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_drive_api::CommentList::CommentList(Json::Value* storage)
  : client::JsonCppData(storage) {
}

// Standard destructor.
google_drive_api::CommentList::~CommentList() {
}
}  // namespace google_drive_api
