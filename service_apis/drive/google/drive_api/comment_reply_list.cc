...
CommentReplyList* CommentReplyList::New() {
  return new client::JsonCppCapsule<CommentReplyList>;
}

// Standard immutable constructor.
CommentReplyList::CommentReplyList(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
CommentReplyList::CommentReplyList(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const client::JsonCppArray<CommentReply > CommentReplyList::get_items() const {
   const Json::Value& storage = Storage("items");
   return client::JsonValueToCppValueHelper<client::JsonCppArray<CommentReply > >(storage);
}

client::JsonCppArray<CommentReply > CommentReplyList::mutable_items() {
