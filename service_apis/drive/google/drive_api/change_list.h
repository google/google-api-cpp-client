...
class ChangeList : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>newStartPageToken</code>' attribute was set.
   *
   * @return true if the '<code>newStartPageToken</code>' attribute was set.
   */
  bool has_new_start_page_token() const {
    return Storage().isMember("newStartPageToken");
  }

  /**
   * Clears the '<code>newStartPageToken</code>' attribute.
   */
  void clear_new_start_page_token() {
    MutableStorage()->removeMember("newStartPageToken");
  }


  /**
   * Get the value of the '<code>newStartPageToken</code>' attribute.
   */
  const StringPiece get_new_start_page_token() const {
    const Json::Value& v = Storage("newStartPageToken");
    if (v == Json::Value::null) return StringPiece("");
    return StringPiece(v.asCString());
  }

  /**
   * Change the '<code>newStartPageToken</code>' attribute.
   *
  ...
  void set_new_start_page_token(const StringPiece& value) {
    *MutableStorage("newStartPageToken") = value.data();
  }
