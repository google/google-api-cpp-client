...
App::AppIcons* App::AppIcons::New() {
  return new client::JsonCppCapsule<AppIcons>;
}

// Standard immutable constructor.
App::AppIcons::AppIcons(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
App::AppIcons::AppIcons(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
// Standard immutable constructor.
App::App(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
App::App(Json::Value* storage)
  : client::JsonCppData(storage) {
}
