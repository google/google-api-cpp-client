...
//     C++: 0.1
#ifndef  GOOGLE_DRIVE_API_CHANNEL_H_
#define  GOOGLE_DRIVE_API_CHANNEL_H_
...
class Channel : public client::JsonCppData {
 public:
   ...
   *
   * @return <code>google_drive_api::Channel</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_drive_api::Channel");
  }
  ...
  const client::JsonCppAssociativeArray<string > get_params() const {
    return client::JsonCppAssociativeArray<string >(Storage("params"));
  }
  ...
  client::JsonCppAssociativeArray<string > mutable_params() {
    return client::JsonCppAssociativeArray<string >(MutableStorage("params"));
  }
   ...
   */
  const StringPiece get_resourceId() const {
   ...
   * @param[in] value The new value.
   */
  void set_resourceId(const StringPiece& value) {
   ...
   */
  const StringPiece get_resourceUri() const {
   ...
   * @param[in] value The new value.
   */
  void set_resourceUri(const StringPiece& value) {
...
#endif  // GOOGLE_DRIVE_API_CHANNEL_H_
