...
google_calendar_api::Colors* google_calendar_api::Colors::New() {
  return new client::JsonCppCapsule<Colors>;
}

// Standard immutable constructor.
google_calendar_api::Colors::Colors(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_calendar_api::Colors::Colors(Json::Value* storage)
  : client::JsonCppData(storage) {
}

// Standard destructor.
google_calendar_api::Colors::~Colors() {
}
}  // namespace google_calendar_api
