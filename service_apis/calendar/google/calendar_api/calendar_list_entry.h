...
class CalendarListEntry : public client::JsonCppData {
 public:
   ...
   */
  const StringPiece get_accessRole() const {
   ...
   */
  void set_accessRole(const StringPiece& value) {
   ...
   */
  const StringPiece get_backgroundColor() const {
   ...
   * @param[in] value The new value.
   */
  void set_backgroundColor(const StringPiece& value) {
   ...
   */
  bool has_defaultReminders() const {
   ...
   * attribute.
   */
  const client::JsonCppArray<EventReminder > get_defaultReminders() const {
    return client::JsonCppArray<EventReminder >(Storage("defaultReminders"));
  }
  ...
  client::JsonCppArray<EventReminder > mutable_defaultReminders() {
    return client::JsonCppArray<EventReminder >(MutableStorage("defaultReminders"));
  }
   ...
   */
  bool has_foregroundColor() const {
   ...
   */
  const StringPiece get_foregroundColor() const {
   ...
   * @param[in] value The new value.
   */
  void set_foregroundColor(const StringPiece& value) {
   ...
   */
  bool has_summaryOverride() const {
   ...
   */
  const StringPiece get_summaryOverride() const {
   ...
   * @param[in] value The new value.
   */
  void set_summaryOverride(const StringPiece& value) {
