...
FreeBusyGroup* FreeBusyGroup::New() {
  return new client::JsonCppCapsule<FreeBusyGroup>;
}

// Standard immutable constructor.
FreeBusyGroup::FreeBusyGroup(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
FreeBusyGroup::FreeBusyGroup(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const client::JsonCppArray<Error > FreeBusyGroup::get_errors() const {
