...
class Event : public client::JsonCppData {
 public:
  ...
  class EventExtendedProperties : public client::JsonCppData {
   public:
    ...
    const client::JsonCppAssociativeArray<string > get_private() const {
      return client::JsonCppAssociativeArray<string >(Storage("private"));
    }
    ...
    client::JsonCppAssociativeArray<string > mutable_private() {
      return client::JsonCppAssociativeArray<string >(MutableStorage("private"));
    }
    ...
    const client::JsonCppAssociativeArray<string > get_shared() const {
      return client::JsonCppAssociativeArray<string >(Storage("shared"));
    }
    ...
    client::JsonCppAssociativeArray<string > mutable_shared() {
      return client::JsonCppAssociativeArray<string >(MutableStorage("shared"));
    }
  ...
  class EventGadget : public client::JsonCppData {
   public:
    ...
    const client::JsonCppAssociativeArray<string > get_preferences() const {
      return client::JsonCppAssociativeArray<string >(Storage("preferences"));
    }
    ...
    client::JsonCppAssociativeArray<string > mutable_preferences() {
      return client::JsonCppAssociativeArray<string >(MutableStorage("preferences"));
    }
   ...
   * indicated with a separate entry in 'attendees' with the 'organizer' field
  ...
  class EventReminders : public client::JsonCppData {
   public:
    ...
    const client::JsonCppArray<EventReminder > get_overrides() const {
      return client::JsonCppArray<EventReminder >(Storage("overrides"));
    }
    ...
    client::JsonCppArray<EventReminder > mutable_overrides() {
      return client::JsonCppArray<EventReminder >(MutableStorage("overrides"));
    }
   ...
   */
  bool has_anyoneCanAddSelf() const {
   ...
   */
  bool get_anyoneCanAddSelf() const {
   ...
   * @param[in] value The new value.
   */
  void set_anyoneCanAddSelf(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
  ...
  const client::JsonCppArray<EventAttendee > get_attendees() const {
    return client::JsonCppArray<EventAttendee >(Storage("attendees"));
  }
  ...
  client::JsonCppArray<EventAttendee > mutable_attendees() {
    return client::JsonCppArray<EventAttendee >(MutableStorage("attendees"));
  }
   ...
   */
  bool has_attendeesOmitted() const {
   ...
   */
  bool get_attendeesOmitted() const {
   ...
   * @param[in] value The new value.
   */
  void set_attendeesOmitted(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
   ...
   */
  const StringPiece get_colorId() const {
   ...
   * @param[in] value The new value.
   */
  void set_colorId(const StringPiece& value) {
  ...
  const EventCreator get_creator() const {
    return EventCreator(Storage("creator"));
  }
  ...
  EventCreator mutable_creator() {
    return EventCreator(MutableStorage("creator"));
  }
  ...
  const EventDateTime get_end() const {
    return EventDateTime(Storage("end"));
  }
  ...
  EventDateTime mutable_end() {
    return EventDateTime(MutableStorage("end"));
  }
   ...
   */
  bool has_endTimeUnspecified() const {
   ...
   */
  bool get_endTimeUnspecified() const {
   ...
   * @param[in] value The new value.
   */
  void set_endTimeUnspecified(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
   ...
   */
  bool has_extendedProperties() const {
   ...
   * attribute.
   */
  const EventExtendedProperties get_extendedProperties() const {
    return EventExtendedProperties(Storage("extendedProperties"));
  }
  ...
  EventExtendedProperties mutable_extendedProperties() {
    return EventExtendedProperties(MutableStorage("extendedProperties"));
  }
  ...
  const EventGadget get_gadget() const {
    return EventGadget(Storage("gadget"));
  }
  ...
  EventGadget mutable_gadget() {
    return EventGadget(MutableStorage("gadget"));
  }
   ...
   */
  bool has_guestsCanInviteOthers() const {
   ...
   */
  void clear_guestsCanInviteOthers() {
   ...
   */
  bool get_guestsCanInviteOthers() const {
   ...
   * @param[in] value The new value.
   */
  void set_guestsCanInviteOthers(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
   ...
   */
  bool has_guestsCanModify() const {
   ...
   */
  bool get_guestsCanModify() const {
   ...
   * @param[in] value The new value.
   */
  void set_guestsCanModify(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
   ...
   * set.
   */
  bool has_guestsCanSeeOtherGuests() const {
   ...
   */
  void clear_guestsCanSeeOtherGuests() {
   ...
   */
  bool get_guestsCanSeeOtherGuests() const {
   ...
   * @param[in] value The new value.
   */
  void set_guestsCanSeeOtherGuests(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
   ...
   */
  const StringPiece get_hangoutLink() const {
   ...
   * @param[in] value The new value.
   */
  void set_hangoutLink(const StringPiece& value) {
   ...
   */
  const StringPiece get_htmlLink() const {
   ...
   * @param[in] value The new value.
   */
  void set_htmlLink(const StringPiece& value) {
   ...
   */
  const StringPiece get_iCalUID() const {
   ...
   * @param[in] value The new value.
   */
  void set_iCalUID(const StringPiece& value) {
  ...
  const EventOrganizer get_organizer() const {
    return EventOrganizer(Storage("organizer"));
  }
  ...
  EventOrganizer mutable_organizer() {
    return EventOrganizer(MutableStorage("organizer"));
  }
   ...
   */
  bool has_originalStartTime() const {
   ...
   * attribute.
   */
  const EventDateTime get_originalStartTime() const {
    return EventDateTime(Storage("originalStartTime"));
  }
  ...
  EventDateTime mutable_originalStartTime() {
    return EventDateTime(MutableStorage("originalStartTime"));
  }
   ...
   * @param[in] value The new value.
   */
  void set_privateCopy(bool value) {
    client::SetJsonValueFromCppValueHelper<bool>(
  ...
  const client::JsonCppArray<string > get_recurrence() const {
    return client::JsonCppArray<string >(Storage("recurrence"));
  }
  ...
  client::JsonCppArray<string > mutable_recurrence() {
    return client::JsonCppArray<string >(MutableStorage("recurrence"));
  }
   ...
   */
  bool has_recurringEventId() const {
   ...
   */
  const StringPiece get_recurringEventId() const {
   ...
   * @param[in] value The new value.
   */
  void set_recurringEventId(const StringPiece& value) {
  ...
  const EventReminders get_reminders() const {
    return EventReminders(Storage("reminders"));
  }
  ...
  EventReminders mutable_reminders() {
    return EventReminders(MutableStorage("reminders"));
  }
  ...
  const EventSource get_source() const {
    return EventSource(Storage("source"));
  }
  ...
  EventSource mutable_source() {
    return EventSource(MutableStorage("source"));
  }
  ...
  const EventDateTime get_start() const {
    return EventDateTime(Storage("start"));
  }
  ...
  EventDateTime mutable_start() {
    return EventDateTime(MutableStorage("start"));
  }
