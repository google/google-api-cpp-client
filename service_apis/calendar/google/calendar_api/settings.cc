...
google_calendar_api::Settings* google_calendar_api::Settings::New() {
  return new client::JsonCppCapsule<Settings>;
}

// Standard immutable constructor.
google_calendar_api::Settings::Settings(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_calendar_api::Settings::Settings(Json::Value* storage)
  : client::JsonCppData(storage) {
}

// Standard destructor.
google_calendar_api::Settings::~Settings() {
}
}  // namespace google_calendar_api
