...
google_calendar_api::Channel* google_calendar_api::Channel::New() {
  return new client::JsonCppCapsule<Channel>;
}

// Standard immutable constructor.
google_calendar_api::Channel::Channel(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_calendar_api::Channel::Channel(Json::Value* storage)
  : client::JsonCppData(storage) {
}
