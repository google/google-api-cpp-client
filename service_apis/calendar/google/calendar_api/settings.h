...
//     C++: 0.1
#ifndef  GOOGLE_CALENDAR_API_SETTINGS_H_
#define  GOOGLE_CALENDAR_API_SETTINGS_H_
 ...
 * @ingroup DataObject
 */
class Settings : public client::JsonCppData {
 public:
   ...
   */
  explicit Settings(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit Settings(Json::Value* storage);
   ...
   *
   * @return <code>google_calendar_api::Settings</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_calendar_api::Settings");
  }
   ...
   */
  const client::JsonCppArray<Setting > get_items() const {
    return client::JsonCppArray<Setting >(Storage("items"));
  }
   ...
   */
  client::JsonCppArray<Setting > mutable_items() {
    return client::JsonCppArray<Setting >(MutableStorage("items"));
  }
...
#endif  // GOOGLE_CALENDAR_API_SETTINGS_H_
