...
DeepLinkData* DeepLinkData::New() {
  return new client::JsonCppCapsule<DeepLinkData>;
}

// Standard immutable constructor.
DeepLinkData::DeepLinkData(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
DeepLinkData::DeepLinkData(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const client::JsonCppArray<Link > DeepLinkData::get_links() const {
   const Json::Value& storage = Storage("links");
