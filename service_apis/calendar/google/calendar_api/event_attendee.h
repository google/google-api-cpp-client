...
class EventAttendee : public client::JsonCppData {
 public:
   ...
   */
  bool has_additionalGuests() const {
   ...
   */
  int32 get_additionalGuests() const {
   ...
   */
  void set_additionalGuests(int32 value) {
   ...
   */
  const StringPiece get_responseStatus() const {
   ...
   * @param[in] value The new value.
   */
  void set_responseStatus(const StringPiece& value) {
