...
class FreeBusyRequest : public client::JsonCppData {
 public:
   ...
   */
  bool has_calendarExpansionMax() const {
   ...
   */
  void clear_calendarExpansionMax() {
   ...
   */
  int32 get_calendarExpansionMax() const {
   ...
   */
  void set_calendarExpansionMax(int32 value) {
   ...
   */
  bool has_groupExpansionMax() const {
   ...
   */
  int32 get_groupExpansionMax() const {
   ...
   * @param[in] value The new value.
   */
  void set_groupExpansionMax(int32 value) {
    client::SetJsonValueFromCppValueHelper<int32>(
  ...
  const client::JsonCppArray<FreeBusyRequestItem > get_items() const {
    return client::JsonCppArray<FreeBusyRequestItem >(Storage("items"));
  }
  ...
  client::JsonCppArray<FreeBusyRequestItem > mutable_items() {
    return client::JsonCppArray<FreeBusyRequestItem >(MutableStorage("items"));
  }
   ...
   */
  client::DateTime get_timeMax() const {
   ...
   */
  client::DateTime get_timeMin() const {
