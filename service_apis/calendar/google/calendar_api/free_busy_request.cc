...
google_calendar_api::FreeBusyRequest* google_calendar_api::FreeBusyRequest::New() {
  return new client::JsonCppCapsule<FreeBusyRequest>;
}

// Standard immutable constructor.
google_calendar_api::FreeBusyRequest::FreeBusyRequest(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
google_calendar_api::FreeBusyRequest::FreeBusyRequest(Json::Value* storage)
  : client::JsonCppData(storage) {
}
