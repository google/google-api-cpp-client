...
class Colors : public client::JsonCppData {
 public:
  ...
  const client::JsonCppAssociativeArray<ColorDefinition > get_calendar() const {
    return client::JsonCppAssociativeArray<ColorDefinition >(Storage("calendar"));
  }
   ...
   * 'calendarListEntry' resource refers to one of these color IDs in its
   * 'color' field. Read-only.
   *
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppAssociativeArray<ColorDefinition > mutable_calendar() {
    return client::JsonCppAssociativeArray<ColorDefinition >(MutableStorage("calendar"));
  }
  ...
  const client::JsonCppAssociativeArray<ColorDefinition > get_event() const {
    return client::JsonCppAssociativeArray<ColorDefinition >(Storage("event"));
  }
  ...
  client::JsonCppAssociativeArray<ColorDefinition > mutable_event() {
    return client::JsonCppAssociativeArray<ColorDefinition >(MutableStorage("event"));
  }
