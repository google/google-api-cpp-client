...
class WaxDataItem : public client::JsonCppData {
 public:
   ...
   */
  const StringPiece get_blobOfData() const {
   ...
   */
  void set_blobOfData(const StringPiece& value) {
   ...
   * @param[in] value The new value.
   */
  void set_sizeInBytes(int32 value) {
