...
class Subscription : public client::JsonCppData {
 public:
   ...
   */
  const client::JsonCppAssociativeArray<string > get_channelParams() const {
   ...
   */
  const StringPiece get_clientToken() const {
   ...
   * @param[in] value The new value.
   */
  void set_clientToken(const StringPiece& value) {
   ...
   */
  const StringPiece get_topicId() const {
   ...
   * @param[in] value The new value.
   */
  void set_topicId(const StringPiece& value) {
   ...
   */
  const StringPiece get_topicUri() const {
   ...
   * @param[in] value The new value.
   */
  void set_topicUri(const StringPiece& value) {
